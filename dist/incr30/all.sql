...
*/
-- SIAC-5977: Aggiunta vista da parte del CSI. - Maurizio - INIZIO
...
SELECT d.attoamm_anno, d.attoamm_numero, e.attoamm_tipo_code,
    ...
    d.validita_inizio AS validita_stato_atto_allegato, a.attoal_causale,
...
FROM siac_t_atto_allegato a, siac_r_atto_allegato_stato b,
   ...
   LEFT JOIN siac_d_class_tipo z ON z.classif_tipo_id = y.classif_tipo_id AND
       (z.classif_tipo_code::text = ANY (ARRAY['CDC'::character varying, 'CDR'::character varying]::text[])),
...
-- SIAC-5977: Aggiunta vista da parte del CSI. - Maurizio - FINE 
