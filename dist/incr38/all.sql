...
select 'OP-GESREP1-BilCons-2018',
'Reportistica Rendiconto della Gestione 2018 (Enti Locali)',
...
and e.codice_fiscale in ('00514490010', '80001630054', '00355580028', '80005210028', '94033780027', '00429440068', '01907990012')
and
a.azione_tipo_code='ATTIVITA_SINGOLA'
and b.gruppo_azioni_code='BIL_CAP_GES' 
and not exists 
(select 1 
    from siac_t_azione z 
	where z.azione_code='OP-GESREP1-BilCons-2018'
...
select 'OP-GESREP2-BilCons-2018',
'Reportistica Gestione 2018 (Regione)',
a.azione_tipo_id,b.gruppo_azioni_id,
'/../siacrepapp/azioneRichiesta.do',
FALSE,
now(),
...
b.ente_proprietario_id=A.ente_proprietario_id
and b.ente_proprietario_id=e.ente_proprietario_id
and e.codice_fiscale not in ('00514490010', '80001630054', '00355580028', '80005210028', '94033780027', '00429440068', '01907990012')
and
a.azione_tipo_code='ATTIVITA_SINGOLA'
and b.gruppo_azioni_code='BIL_CAP_GES' 
and not exists 
(select 1 
    from siac_t_azione z 
	where z.azione_code='OP-GESREP2-BilCons-2018'
	and z.ente_proprietario_id=a.ente_proprietario_id
	and z.data_cancellazione is null
);
