...
select 'DRP',
       'DOCUMENTO A REGOLARIZZAZIONE DI PROVVISORI/SOSPESI',
       'SIAC-6272',
       now(),
...
where 
not exists
(select 1 from siac_d_codicebollo d where d.ente_proprietario_id=e.ente_proprietario_id and d.codbollo_code='DRP' );
...
select bollo.codbollo_id,
       bplus.codbollo_plus_id,
       now(),
       'SIAC-6272',
       bollo.ente_proprietario_id
from siac_d_codicebollo bollo, siac_d_codicebollo_plus bplus
where bollo.codbollo_desc='DOCUMENTO A REGOLARIZZAZIONE DI PROVVISORI/SOSPESI'
and   bplus.ente_proprietario_id=bollo.ente_proprietario_id
and   bplus.codbollo_plus_desc='ESENTE BOLLO'
and   not exists 
(select 1 from siac_r_codicebollo_plus r 
 where r.codbollo_id=bollo.codbollo_id and  r.codbollo_plus_id=bplus.codbollo_plus_id
...
--SIAC-6272 - Sofia - FINE


--SIAC-6216 - Maurizio - INIZIO

DROP FUNCTION if exists siac."BILR085_mandato_di_pagamento"(p_ente_prop_id integer, p_anno varchar, p_num_mandato_da integer, p_num_mandato_a integer, p_data_mandato_da date, p_data_mandato_a date, p_numero_distinta varchar);
...
--SIAC-6216 - Maurizio - FINE


--SIAC-6217 - Maurizio - INIZIO


DROP FUNCTION if exists siac."BILR113_stampa_avviso_pagamento"(p_ente_prop_id integer, p_anno varchar, p_num_mandato_da integer, p_num_mandato_a integer, p_data_mandato_da date, p_data_mandato_a date);
...
--SIAC-6217 - Maurizio - FINE


-- SIAC-6282 - Sofia - Inizio

drop function if exists fnc_siac_dwh_contabilita_generale 
(
...
-- SIAC-6282 - Sofia - Fine

-- SIAC-6250 - Maurizio - INIZIO

DROP FUNCTION if exists siac."BILR186_indic_sint_spe_rend_org_er_pdce_impegni"(p_ente_prop_id integer, p_anno varchar);
...
-- SIAC-6250 - Maurizio - FINE

-- Allineamento da CSI - Maurizio - INIZIO
...
select * from fnc_siac_bko_config_report_BILR150_xbrl();


-- Allineamento da CSI - Maurizio - FINE