...
-- SIAC-6271 - Maurizio - INIZIO 

insert into siac_t_report (rep_codice,  rep_desc,  rep_birt_codice,  validita_inizio,  validita_fine, ente_proprietario_id ,  
	data_creazione,  data_modifica,  data_cancellazione,  login_operazione)
select 'BILR210','Allegato 9 - Prospetto verifica rispetto dei vincoli di finanza pubblica - gestione (BILR210)', 'BILR210_equilibri_di_finanza_pubblica_gest',
now(), NULL, ente_proprietario_id, now(), now(), NULL, 'admin'
from siac_t_ente_proprietario a
where a.data_cancellazione IS NULL
and not exists (select 1 
				from siac_t_report b
				where b.ente_proprietario_id = a.ente_proprietario_id
					and b.rep_codice = 'BILR210');
...
and not exists (select 1 
      ...
      and z.repimp_codice='fpv_ent_spe_corr_rend');
...
and not exists (select 1 
	  ...
	  and z.bil_id = a.bil_id
	  and z.periodo_id = b2.periodo_id
      and z.repimp_codice='fpv_ecc_ncf_rend');	  
...
and not exists (select 1 
	  ...
	  and z.bil_id = a.bil_id
	  and z.periodo_id = b2.periodo_id
      and z.repimp_codice='fpv_epf_rend');	 
...
and not exists (select 1 
	  ...
	  and z.bil_id = a.bil_id
	  and z.periodo_id = b2.periodo_id
      and z.repimp_codice='spazi_fin_acq_rend');
...
and not exists (select 1 
	  ...
	  and z.bil_id = a.bil_id
	  and z.periodo_id = b2.periodo_id
      and z.repimp_codice='fpv_parte_corr_rend');	 
...
and not exists (select 1 
	  ...
	  and z.bil_id = a.bil_id
	  and z.periodo_id = b2.periodo_id
      and z.repimp_codice='fondo_cont_rend');	  
...
and not exists (select 1 
	  ...
	  and z.bil_id = a.bil_id
	  and z.periodo_id = b2.periodo_id
      and z.repimp_codice='altri_acc_rend');	
...
and not exists (select 1 
	  ...
	  and z.bil_id = a.bil_id
	  and z.periodo_id = b2.periodo_id
      and z.repimp_codice='fpv_conto_capit_rend');
...
and not exists (select 1 
	  ...
	  and z.bil_id = a.bil_id
	  and z.periodo_id = b2.periodo_id
      and z.repimp_codice='altri_accanton_rend');
...
INSERT INTO SIAC_T_REPORT_IMPORTI (repimp_codice,
                                   ...
                                   data_cancellazione,
                                   login_operazione)    
select  'spese_incr_att_fin_rend',
...
and not exists (select 1 
	  ...
	  and z.bil_id = a.bil_id
	  and z.periodo_id = b2.periodo_id
      and z.repimp_codice='spese_incr_att_fin_rend');
...
and not exists (select 1 
	  ...
	  and z.bil_id = a.bil_id
	  and z.periodo_id = b2.periodo_id
      and z.repimp_codice='fpv_part_fin_rend');
...
and not exists (select 1 
	  ...
	  and z.bil_id = a.bil_id
	  and z.periodo_id = b2.periodo_id
      and z.repimp_codice='spazi_fin_ced_rend');
...
where  a.repimp_codice in ('fpv_ent_spe_corr_rend', 'fpv_ecc_ncf_rend', 'fpv_epf_rend', 'spazi_fin_acq_rend', 'fpv_parte_corr_rend', 'fondo_cont_rend', 'altri_acc_rend', 
	'fpv_conto_capit_rend', 'altri_accanton_rend', 'spese_incr_att_fin_rend', 'fpv_part_fin_rend', 'spazi_fin_ced_rend')
and not exists (select 1 
...
(rep_codice,
  ...
  repimp_progr_riga)
select 'BILR210',
 'Allegato 9 - Prospetto verifica rispetto dei vincoli di finanza pubblica - gestione (BILR210)',
 'fpv_ent_spe_corr_rend',
 'A1) Fondo pluriennale vincolato di entrata per spese correnti (dal 2020 quota finanziata da entrate finali)',
 0,
 'N',
 1
where  not exists (select 1
 ...
 where a.rep_codice = 'BILR210'
 	and a.repimp_codice = 'fpv_ent_spe_corr_rend');	  
...
where  not exists (select 1
 from BKO_T_REPORT_IMPORTI a
 where a.rep_codice = 'BILR210'
 	and a.repimp_codice = 'fpv_ecc_ncf_rend');	  
...
where  not exists (select 1
 from BKO_T_REPORT_IMPORTI a
 where a.rep_codice = 'BILR210'
 	and a.repimp_codice = 'fpv_epf_rend');	  
...
where  not exists (select 1
 from BKO_T_REPORT_IMPORTI a
 where a.rep_codice = 'BILR210'
 	and a.repimp_codice = 'spazi_fin_acq_rend');	  
...
where  not exists (select 1
 from BKO_T_REPORT_IMPORTI a
 where a.rep_codice = 'BILR210'
 	and a.repimp_codice = 'fpv_parte_corr_rend');	
...
where  not exists (select 1
 from BKO_T_REPORT_IMPORTI a
 where a.rep_codice = 'BILR210'
 	and a.repimp_codice = 'fondo_cont_rend');	
...
where  not exists (select 1
 from BKO_T_REPORT_IMPORTI a
 where a.rep_codice = 'BILR210'
 	and a.repimp_codice = 'altri_acc_rend');		
...
where  not exists (select 1
 from BKO_T_REPORT_IMPORTI a
 where a.rep_codice = 'BILR210'
 	and a.repimp_codice = 'fpv_conto_capit_rend');		
...
where  not exists (select 1
 from BKO_T_REPORT_IMPORTI a
 where a.rep_codice = 'BILR210'
 	and a.repimp_codice = 'altri_accanton_rend');	
...
where  not exists (select 1
 from BKO_T_REPORT_IMPORTI a
 where a.rep_codice = 'BILR210'
 	and a.repimp_codice = 'spese_incr_att_fin_rend');		
...
where  not exists (select 1
 from BKO_T_REPORT_IMPORTI a
 where a.rep_codice = 'BILR210'
 	and a.repimp_codice = 'fpv_part_fin_rend');		
...
where  not exists (select 1
 from BKO_T_REPORT_IMPORTI a
 where a.rep_codice = 'BILR210'
 	and a.repimp_codice = 'spazi_fin_ced_rend');		
	
	
DROP FUNCTION if exists siac."BILR210_equilibri_di_finanza_pubblica_gest_entrate"(p_ente_prop_id integer, p_anno varchar, p_pluriennale varchar);	

DROP FUNCTION if exists siac."BILR210_equilibri_di_finanza_pubblica_gest_spese"(p_ente_prop_id integer, p_anno varchar, p_pluriennale varchar);

CREATE OR REPLACE FUNCTION siac."BILR210_equilibri_di_finanza_pubblica_gest_entrate" (
...
/*
	Procedura copia della BILR143_equilibri_di_finanza_pubblica_entrate, solo
    che estrae i dati dei capitoli di entrata di gestione invece che di
    previsione.
*/
...
CREATE OR REPLACE FUNCTION siac."BILR210_equilibri_di_finanza_pubblica_gest_spese" (
  p_ente_prop_id integer,
  p_anno varchar,
  p_pluriennale varchar = 'S'::character varying
)
...
/*
	Procedura copia della BILR143_equilibri_di_finanza_pubblica_spese, solo
    che estrae i dati dei capitoli di spesa di gestione invece che di
    previsione.
*/
