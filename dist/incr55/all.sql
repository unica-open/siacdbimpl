...
*/
-- SIAC-6360  Maurizio - INIZIO

DROP FUNCTION if exists siac."BILR215_stampa_doc_sint_iva"(p_ente_prop_id integer, p_numero_doc varchar, p_anno_doc integer, p_cod_sog varchar, p_tipo_documento varchar, p_tipo_doc_fam varchar);

CREATE OR REPLACE FUNCTION siac."BILR215_stampa_doc_sint_iva" (
  p_ente_prop_id integer,
  p_numero_doc varchar,
  p_anno_doc integer,
  p_cod_sog varchar,
  p_tipo_documento varchar,
  p_tipo_doc_fam varchar
)
RETURNS TABLE (
  nome_ente varchar,
...
/*
 Questa procedura nasce come copia della BILR106_stampa_fattura_attiva.
 La procedura estrae i dati di uno specifico documento sintetivo IVA di spesa o
 di entrata.
 E' utilizzata dai report "BILR215_stampa_doc_sint_iva_entrate e 
 "BILR216_stampa_doc_sint_iva_spese".
 Il parametro p_tipo_doc_fam che puo' valere 'IE' o 'IS' discrimina se
 estrarre i dati di entrata o spesa.
...
doc_r_id_APP=NULL;
/*  verifico il tipo di legame dell'iva con la fattura:
	- se esite il legame con siac_r_doc_iva l'iva e' legata alla fattura;
    - se il legame NON esiste, l'iva e' legata alle quote della fattura */
...
/* iva e' legata al documento, 
	nella query seguente non c'e' legame con le quote */
    ...
    select 	ep.ente_denominazione, ep.codice_fiscale cod_fisc_ente, 		
            ...
            WHERE  t_doc.ente_proprietario_id=ep.ente_proprietario_id       
               ...
               AND d_doc_fam_tipo.doc_fam_tipo_code = p_tipo_doc_fam
    ...
    loop
        ...
        doc_fam_tipo_code = elencoFatture.doc_fam_tipo_code;
...
ELSE
/* 18/10/2016: iva e' legata alle quote , 
	nella query seguente non c'e' legame con le quote */
