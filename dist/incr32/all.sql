...
-- SIAC-5900 e SIAC-6036 - Maurizio - INIZIO

DROP FUNCTION siac."BILR152_elenco_impegni"(p_ente_prop_id integer, p_anno varchar, p_numero_provv integer, p_anno_provv varchar, p_tipo_provv varchar);

DROP FUNCTION siac."BILR152_elenco_liquidazioni"(p_ente_prop_id integer, p_anno varchar, p_numero_provv integer, p_anno_provv varchar, p_tipo_provv varchar);
...
-- SIAC-5900 e SIAC-6036 - Maurizio - FINE


-- SIAC-5968 - Sofia - INIZIO
...
set voce_conf_ind_tipo = 'P';


ALTER TABLE siac.siac_t_voce_conf_indicatori_sint
  ALTER COLUMN voce_conf_ind_tipo SET NOT NULL;


-- SIAC-5643 FINE

-- SIAC-XXXX   - Sofia - INIZIO 
DROP FUNCTION if exists BILR052_quadro_generale_entrate (integer,  varchar);


CREATE OR REPLACE FUNCTION BILR052_quadro_generale_entrate (
  p_ente_prop_id integer,
  p_anno varchar
)
RETURNS TABLE (
