...
*/
-- 29.07.2019 Sofia SIAC-6971 - inizio

drop FUNCTION if exists fnc_mif_ordinativo_ritenute( ordinativoId integer,
														relazRitOrd varchar,
                                                        relazSubOrd varchar,
                                                        relazSpr varchar,
...
-- 29.07.2019 Sofia siac-6971 - fine

-- 30.07.2019 Sofia SIAC-6950 - inizio
...
drop FUNCTION if exists fnc_mif_ordinativo_spesa_chiu_elab
( enteProprietarioId integer,
  nomeEnte VARCHAR,
  annobilancio varchar,
  loginOperazione varchar,
...
drop FUNCTION if exists fnc_mif_ordinativo_entrata_chiu_elab
( enteProprietarioId integer,
  nomeEnte VARCHAR,
  annobilancio varchar,
  loginOperazione varchar,
...
SECURITY INVOKER
COST 100;
-- 30.07.2019 Sofia SIAC-6950 - fine



-- SIAC-6874 INIZIO

SELECT * from fnc_dba_add_column_params ('siac_t_soggetto', 'login_inserimento_durc', 'VARCHAR(200)');
SELECT * from fnc_dba_add_column_params ('siac_t_soggetto', 'login_modifica_durc', 'VARCHAR(200)');

SELECT * from fnc_dba_add_column_params ('siac_t_soggetto_mod', 'login_inserimento_durc', 'VARCHAR(200)');
SELECT * from fnc_dba_add_column_params ('siac_t_soggetto_mod', 'login_modifica_durc', 'VARCHAR(200)');
