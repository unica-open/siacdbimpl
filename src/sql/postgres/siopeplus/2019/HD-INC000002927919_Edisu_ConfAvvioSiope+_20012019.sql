...
*/
-- 21.01.2019 Sofia INC000002927919_ConfAvvioSiope
-- HD-INC000002927919_Edisu_ConfAvvioSiope+_20012019.sql
...
where e.ente_proprietario_id=13;

update siac_t_ente_oil e
set    ente_oil_codice_ipa='UFB2C3', -- <codice_ente>
       ente_oil_codice_istat='766316', -- <codice_istat_ente>
       ente_oil_codice_tramite='A2A-04255500', -- <codice_tramite_ente>
       ente_oil_codice_tramite_bt='A2A-38628908', -- <codice_tramite_BT>
       ente_oil_codice_pcc_uff='erdsu_to',
...
where ente.ente_proprietario_id=13
and not exists
(
...
where plus.ente_proprietario_id=13
...
and   bollo.codbollo_code in ('99','AI','00')
and   not exists
(
select 1
...
where gruppo.ente_proprietario_id=13
...
where oil.ente_proprietario_id=13
and   oil.accredito_tipo_oil_code='01'
...
and   oil.accredito_tipo_oil_code='07'
and   tipo.ente_proprietario_id=oil.ente_proprietario_id
and   tipo.accredito_tipo_code in ('AS','CI','ASC')
and   tipo.data_cancellazione is null
and   not exists
(
select 1
...
and   oil.accredito_tipo_oil_code='17'
and   tipo.ente_proprietario_id=oil.ente_proprietario_id
and   tipo.accredito_tipo_code in ('STI','DEE','LA','MV','TB','TT','PC')
and   tipo.data_cancellazione is null
and   not exists
(
select 1
