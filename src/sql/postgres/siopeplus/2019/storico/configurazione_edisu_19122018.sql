...
and   tipo_a.ente_proprietario_id=13
and   tipo_a.flusso_elab_mif_tipo_code='MANDMIF_SPLUS';
...
and   tipo_a.ente_proprietario_id=13
and   tipo_a.flusso_elab_mif_tipo_code='REVMIF_SPLUS';
...
and   bollo.codbollo_code in ('00','77','99','DRP');
...
and   bollo.ente_proprietario_id=plus.ente_proprietario_id
and   bollo.codbollo_code in ('SB'); -- non esiste
...
and   bollo.ente_proprietario_id=plus.ente_proprietario_id
and   bollo.codbollo_code in ('TP'); -- non esiste
...
from siac_d_accredito_tipo tipo,siac_d_accredito_gruppo gruppo,
     siac_d_accredito_tipo_oil oil,siac_r_accredito_tipo_oil r
...
and   tipo.ente_proprietario_id=oil.ente_proprietario_id
and   tipo.accredito_tipo_code in ('F2','F3','FT')
and   tipo.data_cancellazione is null;
