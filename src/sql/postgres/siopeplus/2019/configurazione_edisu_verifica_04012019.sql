...
-- MANDMIF_SPLUS 220
-- REVMIF_SPLUS  221
-- Edisu - Ente Diritto allo Studio Universitario
...
-- da esguire per regp, cmto e coal
begin;
update mif_d_flusso_elaborato mif
set    flusso_elab_mif_param=replace(mif.flusso_elab_mif_param,'IT','IX'),
       data_modifica=now(),
       login_operazione=mif.login_operazione||'-SIAC-6605'
from mif_d_flusso_elaborato_tipo tipo
where  tipo.flusso_elab_mif_tipo_code='MANDMIF_SPLUS'
and    mif.flusso_elab_mif_tipo_id=tipo.flusso_elab_mif_tipo_id
and    mif.flusso_elab_mif_code in
