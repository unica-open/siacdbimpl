...
-- HD-INC000002927959_p102_ConfAvvioSiope+_verifica_08012019.sql

-- 789  DIAMANTE SERVIZI BENEDETTI SAMUELE

select *
from siac_r_sistema_esterno_ente r
...
where p.ente_proprietario_id=14
...
where op.ente_proprietario_id=14
