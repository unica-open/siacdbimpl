...
*/
-- 22.02.2019 Sofia HD-INC000002927785_Aipo
-- HD-INC000002927785_Aipo_ConfAvvioSiope+_22012019.sql
...
set    ente_oil_codice_ipa='UF6CSE', -- <codice_ente>
       ente_oil_codice_istat='020997033', -- <codice_istat_ente>
...
and   oil.accredito_tipo_oil_code='17'
and   tipo.ente_proprietario_id=oil.ente_proprietario_id
and   tipo.accredito_tipo_code in ('STI','AI','AV','CE','DP','MF','PC','TE','TT','AP','CI','DEE')
and   tipo.data_cancellazione is null
and   not exists
(
select 1
