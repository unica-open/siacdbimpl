...
where e.ente_proprietario_id=4;
...
update siac_t_ente_oil e
set    ente_oil_codice_ipa='UF6CSE', -- <codice_ente>
       ente_oil_codice_istat='20997033', -- <codice_istat_ente>
       ente_oil_codice_tramite='A2A-04255500', -- <codice_tramite_ente>
       ente_oil_codice_tramite_bt='A2A-38628908', -- <codice_tramite_BT>
       ente_oil_codice_pcc_uff='aiifp_',
...
where plus.ente_proprietario_id=4
...
and   bollo.codbollo_code in ('AI','99','DRP')
and   not exists
(
select 1
...
and   bollo.ente_proprietario_id=plus.ente_proprietario_id
and   bollo.codbollo_code in ('SB','SD')
and   not exists
(
select 1
from siac_r_codicebollo_plus r
...
and   bollo.ente_proprietario_id=plus.ente_proprietario_id
and   bollo.codbollo_code in ('SI','SE')
and   not exists
(
select 1
from siac_r_codicebollo_plus r
...
and   tipo.accredito_tipo_code in ('CON')
and   tipo.data_cancellazione is null
and   not exists
(
select 1
...
and   oil.accredito_tipo_oil_code='02'
and   tipo.ente_proprietario_id=oil.ente_proprietario_id
and   tipo.accredito_tipo_code in ('BP','CB','CCB','CD','BD')
and   tipo.data_cancellazione is null;*/
...
and   oil.accredito_tipo_oil_code='05'
and   tipo.ente_proprietario_id=oil.ente_proprietario_id
and   tipo.accredito_tipo_code in ('CCP','CP','PP')
and   tipo.data_cancellazione is null
and   not exists
(
select 1
...
and   oil.accredito_tipo_oil_code='06'
and   tipo.ente_proprietario_id=oil.ente_proprietario_id
and   tipo.accredito_tipo_code in ('AB','ASBP')
and   tipo.data_cancellazione is null
and   not exists
(
select 1
...
and   oil.accredito_tipo_oil_code='08'
and   tipo.ente_proprietario_id=oil.ente_proprietario_id
and   tipo.accredito_tipo_code in ('TE','F24EP')
and   tipo.data_cancellazione is null
and   not exists
(
select 1
...
and   oil.accredito_tipo_oil_code='17'
and   tipo.ente_proprietario_id=oil.ente_proprietario_id
and   tipo.accredito_tipo_code in ('STI','AI','AV','CE','DP','MF','PC','TT','AP','CI','DEE')
and   tipo.data_cancellazione is null
and   not exists
(
select 1
...
from siac_d_oil_esito_derivato oil
where oil.ente_proprietario_id=4
and   oil.oil_esito_derivato_code='QUIETANZA'and   not exists
(
select 1
...
set     accredito_tipo_id=accreCB.accredito_tipo_id,
	    data_modifica=now(),
...
and   accrecb.ente_proprietario_id=tipo.ente_proprietario_id
and   accrecb.accredito_tipo_code='CB'
