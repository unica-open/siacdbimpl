...
*/
-- 21.01.2019 Sofia HD-INC000002927919_Edisu

-- HD-INC000002927919_Edisu_ConfAvvioSiope+_verifica_20012019.sql
...
where mif.ente_proprietario_id=13
and   exists
(
select 1
from mif_d_flusso_elaborato_tipo tipo
...
select length(codbollo_desc), p.*
from siac_d_codicebollo p
where p.ente_proprietario_id=13

--IMPOSTA DI BOLLO ASSOLTA IN MODO VIRTUALE AUTORIZZAZIONE DELL’AGENZIA DELLE ENTRATE- DIREZIONE PROVINCIALE I DI TORINO- UFFICIO TERRITORIALE DI TORINO 3 PROT 88197 DEL 06/07/2017
...
where op.ente_proprietario_id=13
