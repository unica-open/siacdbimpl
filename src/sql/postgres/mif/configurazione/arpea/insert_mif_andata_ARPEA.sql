...
VALUES
( '751335','02008','0001','751335' ,'6220600',FALSE,TRUE,
...
( select accr.accredito_tipo_id,oil.accredito_tipo_oil_id,'2016-01-01',accr.ente_proprietario_id,'admin'
  from siac_d_accredito_tipo accr , siac_d_accredito_tipo_oil oil
  where accr.ente_proprietario_id=10
  and   accr.accredito_tipo_code in ('AP','CT','F2','ST','TT')
  and   oil.ente_proprietario_id=10
...
( select accr.accredito_tipo_id,oil.accredito_tipo_oil_id,'2016-01-01',accr.ente_proprietario_id,'admin'
  from siac_d_accredito_tipo accr , siac_d_accredito_tipo_oil oil
  where accr.ente_proprietario_id=10
  and   accr.accredito_tipo_code in ('AS')
  and   oil.ente_proprietario_id=10
...
INSERT INTO siac_r_accredito_tipo_oil( accredito_tipo_id, accredito_tipo_oil_id,  validita_inizio, ente_proprietario_id,  login_operazione)
( select accr.accredito_tipo_id,oil.accredito_tipo_oil_id,'2015-01-01',accr.ente_proprietario_id,'admin'
  from siac_d_accredito_tipo accr , siac_d_accredito_tipo_oil oil
  where accr.ente_proprietario_id=10
  and   accr.accredito_tipo_code in ('')
  and   oil.ente_proprietario_id=10
