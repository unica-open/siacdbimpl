...
( '000000','00000','0001','000000' ,'0000000',FALSE,FALSE,
  'Cassa di Risparmio di Asti', 'Cristiana Robba' , 'Graziano Del Mastro  Cristiana Robba',
  18,'2016-01-01','admin');
...
values
('MANDMIF','Flusso XML Mandati (ordinativi spesa)','MANDMIF','2016-01-01','admin',18);


insert into mif_d_flusso_elaborato_tipo
( flusso_elab_mif_tipo_code, flusso_elab_mif_tipo_desc  ,flusso_elab_mif_nome_file, validita_inizio,login_operazione,ente_proprietario_id)
values
('REVMIF','Flusso XML Reversali (ordinativi entrata)','REVMIF','2016-01-01','admin',18);
...
set flusso_elab_mif_default='92022260050'
...
update 	mif_d_flusso_elaborato d
set flusso_elab_mif_default='Ente di Gestione del Parco Paleontologico Astigiano'
from mif_d_flusso_elaborato_tipo tipo
where tipo.ente_proprietario_id=18
and   tipo.flusso_elab_mif_tipo_code='MANDMIF'
and   d.flusso_elab_mif_tipo_id=tipo.flusso_elab_mif_tipo_id
...
update 	mif_d_flusso_elaborato d
set flusso_elab_mif_default='Asti'
from mif_d_flusso_elaborato_tipo tipo
where tipo.ente_proprietario_id=18
and   tipo.flusso_elab_mif_tipo_code='MANDMIF'
and   d.flusso_elab_mif_tipo_id=tipo.flusso_elab_mif_tipo_id
...
update 	mif_d_flusso_elaborato d
set flusso_elab_mif_default='Corso Vittorio Alfieri 381'
from mif_d_flusso_elaborato_tipo tipo
where tipo.ente_proprietario_id=18
and   tipo.flusso_elab_mif_tipo_code='MANDMIF'
and   d.flusso_elab_mif_tipo_id=tipo.flusso_elab_mif_tipo_id
