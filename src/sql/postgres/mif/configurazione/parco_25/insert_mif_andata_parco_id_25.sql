...
( '000000','00000','0001','000000' ,'0000000',FALSE,FALSE,
  'Unicredit Banca', 'Elisabetta Oddi' , 'Dott.ssa Stefania Grella',
  25,'2016-01-01','admin');
...
values
('MANDMIF','Flusso XML Mandati (ordinativi spesa)','MANDMIF','2016-01-01','admin',25);


insert into mif_d_flusso_elaborato_tipo
( flusso_elab_mif_tipo_code, flusso_elab_mif_tipo_desc  ,flusso_elab_mif_nome_file, validita_inizio,login_operazione,ente_proprietario_id)
values
('REVMIF','Flusso XML Reversali (ordinativi entrata)','REVMIF','2016-01-01','admin',25);
