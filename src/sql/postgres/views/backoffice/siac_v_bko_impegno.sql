...
*/
﻿CREATE VIEW siac.siac_v_bko_impegno (
    movgest_tipo_code,
    movgest_tipo_desc,
    bil_id,
...
WHERE m.movgest_id = mt.movgest_id AND mt.movgest_ts_id = mtd.movgest_ts_id AND
    t.movgest_tipo_id = m.movgest_tipo_id AND tt.movgest_ts_tipo_id = mt.movgest_ts_tipo_id AND ttd.movgest_ts_det_tipo_id = mtd.movgest_ts_det_tipo_id AND t.movgest_tipo_code::text = 'I'::text;