...
*/
CREATE OR REPLACE VIEW siac.siac_v_dwh_tit_tip_cat (
    cod_titolotipologiacategoria,
    desc_titolotipologiacategoria,
    tipo,
    id,
    id_padre,
    ...
    validita_fine)
AS
SELECT t1.classif_code AS cod_titolotipologiacategoria,
    t1.classif_desc AS desc_titolotipologiacategoria,
