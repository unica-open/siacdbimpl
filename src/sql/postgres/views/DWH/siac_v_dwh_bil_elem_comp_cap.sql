...
*/
-- 24.11.2020 Sofia Jira SIAC-7893 SIAC-7895
...
FROM ( WITH comp_tipo AS (
    SELECT macro.elem_det_comp_macro_tipo_code,
                    ...
                    tipo.elem_det_comp_tipo_id::character varying(200) AS
                        elem_det_comp_tipo_code,
    ...
    FROM siac_d_bil_elem_det_comp_tipo_stato stato,
                    ...
                    siac_d_bil_elem_det_comp_tipo tipo
                     ...
                     LEFT JOIN siac_d_bil_elem_det_comp_tipo_imp imp_tipo ON
                         tipo.elem_det_comp_tipo_imp_id = imp_tipo.elem_det_comp_tipo_imp_id
    ...
    SELECT capitolo.elem_code AS elem_code_capitolo,
            ...
            comp_tipo.elem_det_comp_tipo_id,
