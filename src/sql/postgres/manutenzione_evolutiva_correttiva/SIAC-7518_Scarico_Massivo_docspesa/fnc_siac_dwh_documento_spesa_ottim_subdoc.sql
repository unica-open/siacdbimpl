...
CREATE OR REPLACE FUNCTION siac.fnc_siac_dwh_documento_spesa_ottim_subdoc
(
...
if annoStorico is null then
	annoStorico:=extract( year from now()::timestamp);
end if;
-- 26.01.2021 Sofia JIRA siac-7518
...
/*      27.01.2021 Sofia Jira SIAC-7518
...
/*      27.01.2021 Sofia Jira SIAC-7518
        ...
        -- and h.doc_id=a.doc_id SIAC-7518
        ...
        (
         ...
         from  siac_t_bil anno,siac_t_periodo per,
               ...
               siac_t_subdoc sub -- 27.01.2021 Sofia Jira SIAC-7518
         where f.doc_stato_code='EM'
         and   sub.doc_id=a.doc_id -- 27.01.2021 Sofia Jira SIAC-7518
         and   rsub.subdoc_id=sub.subdoc_id -- 27.01.2021 Sofia Jira SIAC-7518
        ...
        -- AND h.data_cancellazione IS NULL -- SIAC-7518
     )
     select doc_tot.*
...
c.soggetto_id,d.soggetto_tipo_desc
 from siac_r_soggetto_tipo c,
  ...
  -- 27.01.2021 Sofia 27.01.2021 Jira SIAC-7518
  subdoc as
  (
	  select
            h.subdoc_numero, h.subdoc_desc, h.subdoc_importo, h.subdoc_nreg_iva, h.subdoc_data_scadenza,
     ...
     from   siac_t_subdoc h
        	...
        	left join siac_d_siope_scadenza_motivo m on m.siope_scadenza_motivo_id = h.siope_scadenza_motivo_id
                                                   and m.data_cancellazione is null
                                                   and m.validita_fine is null
     where h.ente_proprietario_id=p_ente_proprietario_id
...
c.ord_anno, c.ord_numero, b.ord_ts_code, g.anno
  ...
  --doc.subdoc_id, -- SIAC-7518
  subdoc.subdoc_id,  -- SIAC-7518 Sofia 27.01.2021
...
-- 27.01.2021 Sofia Jira SIAC-7518
subdoc.subdoc_numero v_num_subdoc, subdoc.subdoc_desc v_desc_subdoc,subdoc.subdoc_importo v_importo_subdoc,
subdoc.subdoc_nreg_iva v_num_reg_iva_subdoc, subdoc.subdoc_data_scadenza v_data_scadenza_subdoc,
subdoc.subdoc_convalida_manuale v_convalida_manuale_subdoc, subdoc.subdoc_importo_da_dedurre v_importo_da_dedurre_subdoc,
subdoc.subdoc_splitreverse_importo v_splitreverse_importo_subdoc,
subdoc.subdoc_pagato_cec v_pagato_cec_subdoc,
subdoc.subdoc_data_pagamento_cec v_data_pagamento_cec_subdoc,
...
-- 27.01.2021 Sofia Jira SIAC-7518
subdoc.siope_tipo_debito_code, subdoc.siope_tipo_debito_desc, subdoc.siope_tipo_debito_desc_bnkit,
subdoc.siope_assenza_motivazione_code, subdoc.siope_assenza_motivazione_desc, subdoc.siope_assenza_motivazione_desc_bnkit,
subdoc.siope_scadenza_motivo_code, subdoc.siope_scadenza_motivo_desc, subdoc.siope_scadenza_motivo_desc_bnkit,
...
--subdoc
subdoc
left join notes on subdoc.notetes_id=notes.notetes_id
left join dist  on subdoc.dist_id=dist.dist_id
left join contes on subdoc.contotes_id=contes.contotes_id
left join attoamm on subdoc.subdoc_id=attoamm.subdoc_id
left join commt on subdoc.comm_tipo_id=commt.comm_tipo_id
left join eldocattall on subdoc.subdoc_id=eldocattall.subdoc_id
left join split on subdoc.subdoc_id=split.subdoc_id
left join liq on subdoc.subdoc_id=liq.subdoc_id --origina multipli
left join  subcltipoavviso on subdoc.subdoc_id=subcltipoavviso.subdoc_id
left join subdocattr1 on subdoc.subdoc_id=subdocattr1.subdoc_id
left join subdocattr2 on subdoc.subdoc_id=subdocattr2.subdoc_id
left join subdocattr3 on subdoc.subdoc_id=subdocattr3.subdoc_id
left join subdocattr4 on subdoc.subdoc_id=subdocattr4.subdoc_id
left join subdocattr5 on subdoc.subdoc_id=subdocattr5.subdoc_id
left join subdocattr6 on subdoc.subdoc_id=subdocattr6.subdoc_id
left join subdocattr7 on subdoc.subdoc_id=subdocattr7.subdoc_id
left join subdocattr8 on subdoc.subdoc_id=subdocattr8.subdoc_id
left join subdocattr9 on subdoc.subdoc_id=subdocattr9.subdoc_id
left join subdocattr10 on subdoc.subdoc_id=subdocattr10.subdoc_id
--left join subdocattr11 on doc.subdoc_id=subdocattr11.subdoc_id
left join subdocattr12 on subdoc.subdoc_id=subdocattr12.subdoc_id
left join subdocattr13 on subdoc.subdoc_id=subdocattr13.subdoc_id
left join subdocattr14 on subdoc.subdoc_id=subdocattr14.subdoc_id
left join subdocattr15 on subdoc.subdoc_id=subdocattr15.subdoc_id
--left join subdocattr16 on doc.subdoc_id=subdocattr16.subdoc_id
left join subdocattr17 on subdoc.subdoc_id=subdocattr17.subdoc_id
left join subdocattr18 on subdoc.subdoc_id=subdocattr18.subdoc_id
left join subdocattr19 on subdoc.subdoc_id=subdocattr19.subdoc_id
--left join subdocattr20 on doc.subdoc_id=subdocattr20.subdoc_id jira 5764
left join soggsub on soggsub.subdoc_id = subdoc.subdoc_id
left join imp on imp.subdoc_id=subdoc.subdoc_id
left join modpag on modpag.subdoc_id=subdoc.subdoc_id
left join ord on ord.subdoc_id = subdoc.subdoc_id
where doc.doc_id=subdoc.doc_id -- 27.01.2021 Sofia jira SIAC-7518
) as tb;
