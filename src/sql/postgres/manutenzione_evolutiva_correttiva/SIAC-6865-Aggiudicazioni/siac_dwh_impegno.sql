...
﻿CREATE TABLE siac.siac_dwh_impegno (
  ...
  -- SIAC-6858 Sofia -- 04.08.2020 -- aggiudicazioni
  annoprenotazioneorigine integer,
  anno_impegno_aggiudicazione integer,
  num_impegno_aggiudicazione  integer,
  num_modif_aggiudicazione    integer
)
WITH (oids = false);
