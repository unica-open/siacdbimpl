...
ALTER FUNCTION siac.fnc_pagopa_t_riconc_aggiorna_accertamento(integer, integer, integer, integer, integer)
    OWNER TO siac;

GRANT EXECUTE ON FUNCTION siac.fnc_pagopa_t_riconc_aggiorna_accertamento(integer, integer, integer, integer, integer) TO siac_rw;

GRANT EXECUTE ON FUNCTION siac.fnc_pagopa_t_riconc_aggiorna_accertamento(integer, integer, integer, integer, integer) TO PUBLIC;

GRANT EXECUTE ON FUNCTION siac.fnc_pagopa_t_riconc_aggiorna_accertamento(integer, integer, integer, integer, integer) TO siac;
