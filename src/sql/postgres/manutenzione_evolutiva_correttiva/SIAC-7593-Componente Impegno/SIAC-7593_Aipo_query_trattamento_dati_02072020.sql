...
where imp.ente_proprietario_id=4
...
from impegno
  ...
  left join  siac_d_bil_elem_det_comp_tipo comp
    ...
    and ( case when query.componente_impegno_tipo='parte fresca' then comp.elem_det_comp_tipo_desc='GENERICA'
    	       when query.componente_impegno_tipo like '%FPV%'    then comp.elem_det_comp_tipo_desc='GENERICA'
