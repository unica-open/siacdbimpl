...
raise notice 'fnc_dba_refresh_materialized_view prima';
 select siac.fnc_dba_refresh_materialized_view('siac_v_dwh_vincoli_originari')into s_risultato;
raise notice 'fnc_dba_refresh_materialized_view dopo = %',s_risultato;
