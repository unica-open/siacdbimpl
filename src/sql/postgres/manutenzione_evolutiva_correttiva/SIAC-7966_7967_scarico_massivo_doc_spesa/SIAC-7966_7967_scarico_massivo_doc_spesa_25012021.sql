...
esito:= 'Fine funzione carico documenti spesa - variabili (FNC_SIAC_DWH_DOCUMENTO_SPESA) - '||clock_timestamp();
RETURN NEXT;
...
esito:= 'Fine funzione carico documenti spesa - storici (FNC_SIAC_DWH_DOCUMENTO_SPESA) - '||clock_timestamp();
RETURN NEXT;
