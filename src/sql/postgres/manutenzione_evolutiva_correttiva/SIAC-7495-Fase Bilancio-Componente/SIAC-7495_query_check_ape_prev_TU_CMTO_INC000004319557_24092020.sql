...
where comp.ente_proprietario_id=3
...
where macro.ente_proprietario_id=3
...
and   per.periodo_id=det.periodo_id
and   tipo_Det.elem_det_tipo_id=det.elem_det_tipo_id
and   tipo_det.elem_det_tipo_code in ('STA','SCA','STR')
and   exists
(
select 1
from siac_t_bil_elem_det  det1,siac_d_bil_elem_det_tipo tipo1
where det1.elem_id=e.elem_id
and   tipo1.elem_det_tipo_id=det1.elem_Det_tipo_id
--and   tipo1.elem_det_tipo_code='STA'
and   det1.data_cancellazione is null
having sum(det1.elem_det_importo)=0
)
and   e.data_cancellazione is null
and   det.data_cancellazione is null
and   det.validita_fine is null
order by 1--anno.anno_bilancio, tipo.elem_tipo_code,3,4,5