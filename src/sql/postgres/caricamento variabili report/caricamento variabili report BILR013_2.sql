...
INSERT INTO SIAC_T_REPORT_IMPORTI (repimp_codice,
                                   ...
                                   data_cancellazione,
                                   login_operazione)                                                                   
select  'fpv_finale_presunto_anno_prec',
        'Fondo pluriennale vincolato finale presunto dell''esercizio precedente',
        0,
        'N',
        28,
        a.bil_id,
...
where  a.repimp_codice = 'fpv_finale_presunto_anno_prec';	
