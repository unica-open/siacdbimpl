...
*/
CREATE TABLE siac.siac_rep_persona_fisica_modpag (
  soggetto_id INTEGER,
...
COMMENT ON COLUMN siac.siac_rep_persona_fisica_modpag.mp_data_scadenza
IS 'data scadenza della modalità di pagamento';

COMMENT ON COLUMN siac.siac_rep_persona_fisica_modpag.data_scadenza_cessione
IS 'data scadenza modalità di pagamento relativa alla cessione';