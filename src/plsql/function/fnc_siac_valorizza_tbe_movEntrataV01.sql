...
WITH (oids = false);
*/
/*drop function fnc_siac_valorizza_tbe_moventrata
  (enteproprietarioid integer,
  loginoperazione varchar,
  setnull_tbe varchar,
  out codicerisultato integer,
  out messaggiorisultato varchar)*/
CREATE OR REPLACE FUNCTION siac.fnc_siac_valorizza_tbe_moventrata (
  enteproprietarioid integer,
  loginoperazione varchar,
  setnull_tbe varchar,
  out codicerisultato integer,
...
--          and date_trunc ('DAY', data_creazione) = date_trunc ('DAY', now()))
    ...
    loop
		...
		/* 12.01.2016 Nessuna vefifica sull'obbligatorietà dei classificatori
