...
*/
--2038
--select * from siac_t_soggetto  where soggetto_code = '2038' and data_cancellazione is null;
--drop function fnc_siac_cons_entita_liquidazione_from_soggetto ( _uid_soggetto integer, _anno varchar, _limit integer, _page integer);
...
--select * from  fnc_siac_cons_entita_liquidazione_from_soggetto (132727 , '2018',100,0);   
