...
*/
﻿CREATE OR REPLACE FUNCTION siac.fnc_siac_cons_entita_documento_from_allegato (
...
BEGIN
	...
	ORDER BY doc.doc_anno, doc.doc_numero, doc.subdoc_numero
	LIMIT _limit
	OFFSET _offset;
END;
$body$
