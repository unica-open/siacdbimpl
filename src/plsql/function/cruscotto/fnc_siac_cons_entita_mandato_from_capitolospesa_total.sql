...
*/
﻿drop function siac.fnc_siac_cons_entita_mandato_from_capitolospesa_total (integer);
drop function siac.fnc_siac_cons_entita_mandato_from_capitolospesa_total (integer,varchar);
