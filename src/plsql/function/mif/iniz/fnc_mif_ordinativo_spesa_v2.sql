...
-- 		 and  date_trunc('day',dataFineVal)<=date_trunc('day',coalesce(elem.validita_fine,dataFineVal))
    ...
    flussoElabMifElabRec:=mifFlussoElabMifArr[93];
...
/*    strMessaggio:='Lettura dati configurazione per campo '||mifFlussoElabTypeRec.tipo_ritenuta
   ...
   if isRitenutaAttivo=true then
   	 flussoElabMifElabRec:=null;
     flussoElabMifElabRec:=mifFlussoElabMifArr[94];
/*     strMessaggio:='Lettura dati configurazione per campo '||mifFlussoElabTypeRec.importo_ritenuta
     ...
     if isRitenutaAttivo=true then
     	flussoElabMifElabRec:=null;
        flussoElabMifElabRec:=mifFlussoElabMifArr[95];
     ...
     if isRitenutaAttivo=true then
     	flussoElabMifElabRec:=null;
        flussoElabMifElabRec:=mifFlussoElabMifArr[96];
/*	    strMessaggio:='Lettura dati configurazione per campo '||mifFlussoElabTypeRec.progressivo_reversale
   ...
   -- <importo_ricevuta>
   flussoElabMifElabRec:=null;
   flussoElabMifElabRec:=mifFlussoElabMifArr[123];
   ...
   if isRicevutaAttivo=true then
   	flussoElabMifElabRec:=null;
    flussoElabMifElabRec:=mifFlussoElabMifArr[124];
...
/*        strMessaggio:='Lettura dati ordinativo numero='||mifOrdinativoIdRec.mif_ord_ord_numero
        ...
        codiceCge:=null;
        --mifCountRec:=mifCountRec+1;
        flussoElabMifElabRec:=mifFlussoElabMifArr[166];
        strMessaggio:='Lettura dati ordinativo numero='||mifOrdinativoIdRec.mif_ord_ord_numero
                       ||' annoBilancio='||mifOrdinativoIdRec.mif_ord_anno_bil
                       ||' ord_id='||mifOrdinativoIdRec.mif_ord_ord_id
                       ||' mif_ord_id='||mifOrdinativoIdRec.mif_ord_id
...
--                    and tipo.ente_proprietario_id=enteProprietarioId
        ...
        flussoElabMifElabRec:=null;
        --mifCountRec:=mifCountRec+1;
        flussoElabMifElabRec:=mifFlussoElabMifArr[167];
        strMessaggio:='Lettura dati ordinativo numero='||mifOrdinativoIdRec.mif_ord_ord_numero
                       ||' annoBilancio='||mifOrdinativoIdRec.mif_ord_anno_bil
                       ||' ord_id='||mifOrdinativoIdRec.mif_ord_ord_id
                       ||' mif_ord_id='||mifOrdinativoIdRec.mif_ord_id
...
/*       strMessaggio:='Lettura dati ordinativo numero='||mifOrdinativoIdRec.mif_ord_ord_numero
        ...
        if flussoElabMifElabRec.flussoElabMifAttivo=true then
         if flussoElabMifElabRec.flussoElabMifElab=true then
            ...
            -- se non è girofondo o se lo è ma il contocorrente_intestazione è vuoto
            ...
            if codAccreRec.accredito_gruppo_code!=tipoMDPCbi or
               MDPRec.contocorrente_intestazione is null then
...
/*            strMessaggio:='Lettura dati ordinativo numero='||mifOrdinativoIdRec.mif_ord_ord_numero
       ...
       -- mifCountRec:=mifCountRec+1;
        flussoElabMifElabRec:=mifFlussoElabMifArr[122];
		strMessaggio:='Lettura dati ordinativo numero='||mifOrdinativoIdRec.mif_ord_ord_numero
                       ||' annoBilancio='||mifOrdinativoIdRec.mif_ord_anno_bil
                       ||' ord_id='||mifOrdinativoIdRec.mif_ord_ord_id
                       ||' mif_ord_id='||mifOrdinativoIdRec.mif_ord_id
...
/*      	strMessaggio:='Lettura dati ordinativo numero='||mifOrdinativoIdRec.mif_ord_ord_numero
        ...
        flussoElabMifElabRec:=null;
     	flussoElabMifValore:=null;
        flussoElabMifElabRec:=mifFlussoElabMifArr[87];
        strMessaggio:='Lettura dati ordinativo numero='||mifOrdinativoIdRec.mif_ord_ord_numero
                       ||' annoBilancio='||mifOrdinativoIdRec.mif_ord_anno_bil
                       ||' ord_id='||mifOrdinativoIdRec.mif_ord_ord_id
                       ||' mif_ord_id='||mifOrdinativoIdRec.mif_ord_id
      ...
      if flussoElabMifElabRec.flussoElabMifAttivo=true then
      	if flussoElabMifElabRec.flussoElabMifElab=true then
        		if flussoElabMifElabRec.flussoElabMifParam is not null then
                    ...
                    if flussoElabMifValore is not null then
                    	mifFlussoOrdinativoRec.mif_ord_dispe_somme_non_sogg:=flussoElabMifValore;
                    end if;
...
/* 	 strMessaggio:='Lettura dati ordinativo numero='||mifOrdinativoIdRec.mif_ord_ord_numero
                ...
                if codiceTribId is not null then
                    ...
                    if oneriCauRec is not null then
                    	if oneriCauRec.listaOneri is not null then
	                        mifFlussoOrdinativoRec.mif_ord_dispe_cod_trib:=oneriCauRec.listaOneri;
                        end if;
                    end if;
                end if;
	 ...
	 if oneriCauRec is not null then
        ...
        if flussoElabMifElabRec.flussoElabMifAttivo=true then
      		if flussoElabMifElabRec.flussoElabMifElab=true then
            	mifFlussoOrdinativoRec.mif_ord_dispe_causale_770:=oneriCauRec.listaCausali;
        	else
     			RAISE EXCEPTION ' Configurazione tag/campo  non elaborabile.';
	    	end if;
		 end if;
...
--                end if;
 ...
 strMessaggio:='Lettura dati ordinativo numero='||mifOrdinativoIdRec.mif_ord_ord_numero
  ...
  if flussoElabMifElabRec.flussoElabMifAttivo=true then
 	 if flussoElabMifElabRec.flussoElabMifElab=true then
            	mifFlussoOrdinativoRec.mif_ord_dispe_capitolo_peg:=bilElemRec.elem_code;
     else
     	RAISE EXCEPTION ' Configurazione tag/campo  non elaborabile.';
     end if;
  end if;
...
/*  strMessaggio:='Lettura dati ordinativo numero='||mifOrdinativoIdRec.mif_ord_ord_numero
 ...
 -- raise notice 'Fatture %',strMessaggio;
  if flussoElabMifElabRec.flussoElabMifId is null then
  		  RAISE EXCEPTION ' Configurazione tag/campo non presente in archivio.';
  end if;
  if flussoElabMifElabRec.flussoElabMifAttivo=true then
...
/*  strMessaggio:='Lettura dati ordinativo numero='||mifOrdinativoIdRec.mif_ord_ord_numero
  ...
  if anagraficaBenefCBI is not null then
	  ...
	  if flussoElabMifElabRec.flussoElabMifAttivo=true then
   		if flussoElabMifElabRec.flussoElabMifElab=true then
	     	mifFlussoOrdinativoRec.mif_ord_dispe_beneficiario:=substring(anagraficaBenefCBI from 1 for 140);
	    else
			RAISE EXCEPTION ' Configurazione tag/campo  non elaborabile.';
	  	end if;
	  end if;
        ...
        lpad(extract('day' from now())::varchar,2,'0'),
