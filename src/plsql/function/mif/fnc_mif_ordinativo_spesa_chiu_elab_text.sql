...
CREATE OR REPLACE FUNCTION fnc_mif_ordinativo_spesa_chiu_elab_text
...
BEGIN
    ...
    strMessaggioFinale:='Chiusura elaborazione trasmissione ordinativi spesa.';

    strMessaggio:='Chiamata fnc_mif_ordinativo_spesa_chiu_elab.';
	select * into chiuElabRec
    from fnc_mif_ordinativo_spesa_chiu_elab
