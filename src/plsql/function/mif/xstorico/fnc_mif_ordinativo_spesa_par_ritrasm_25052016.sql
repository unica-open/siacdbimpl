...
-- 14.04.2016 Sofia - fnc_mif_ordinativo_spesa con parametro di ritrasmissione
...
-- ordinativoTsDetTipoId integer:=null;
 ...
 flussoElabMifDistOilId integer:=null;
...
--		if enteOilRec.ente_oil_quiet_ord=true then -- 01.03.2016 Sofia va gestisto se il flag = false ente non gestisce quietanza
        ...
        if flussoElabMifDistOilId is null then
        ...
        if flussoElabMifDistOilId is not null then
	        flussoElabMifDistOilId:=flussoElabMifDistOilId+1;
        end if;
