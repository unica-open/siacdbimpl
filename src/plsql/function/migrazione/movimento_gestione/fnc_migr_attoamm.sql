...
*/
CREATE OR REPLACE FUNCTION fnc_migr_attoamm (
  annoattoamm varchar,
...
begin
    ...
    begin
        ...
        -- 12.05.2015 daniela, uso funzione postgres split_part
...
*/
   ...
   if insAttoAmm=TRUE then
	   messaggioRisultato:=strMessaggioFinale||'Inserito Atto Amm';
   else
	   messaggioRisultato:=strMessaggioFinale||'Trovato Atto Amm.';
   end if;
