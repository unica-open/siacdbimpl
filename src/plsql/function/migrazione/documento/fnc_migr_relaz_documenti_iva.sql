...
*/
drop FUNCTION fnc_migr_relaz_documenti_iva (
...
BEGIN
    ...
    dataInizioVal:=date_trunc('DAY', now());
  	...
  	strMessaggioFinale:='Migrazione relazione documenti iva da id ['||idMin||'] a id ['||idMax||']';
	...
	begin
        ...
        and   ms.fl_elab='N'
		and   ms.migr_relazdocquo_id >= idMin and ms.migr_relazdocquo_id <= idMax;
