...
and   (p_tefa_trib_gruppo_tipo_id is null or 
       (p_tefa_trib_gruppo_tipo_id is not null and not (trib_imp.tefa_trib_tributo_code in ('3920','3921','3922') and trib_imp.tefa_trib_anno_rif::integer=2020) )
      ) 
...
alter function siac.fnc_tefa_trib_raggruppamento
