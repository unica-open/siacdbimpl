...
' and   tefa.tefa_trib_tipo_record=''D''
  and   not (tefa.tefa_trib_tributo_code in (''3920'',''3921'',''3922'') and tefa.tefa_trib_anno_rif::integer=2020)
...
alter function siac.fnc_tefa_trib_versamenti_estrai
( integer, integer, integer ) owner to siac;