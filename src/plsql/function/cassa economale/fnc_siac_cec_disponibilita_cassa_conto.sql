...
*/
﻿CREATE OR REPLACE FUNCTION siac.fnc_siac_cec_disponibilita_cassa_conto (
...
and g.anno=anno_in
and e.cassaecon_id=id_cassaecon_in)   
select ope.disponibilita_cassa_conto+giu_r.rend_importo_restituito-recon.ricecon_importo-giu_i.rend_importo_integrato-opu.disponibilita_cassa_conto 
...
select 
ope.disponibilita_cassa_conto+giu_r.rend_importo_restituito
-recon.ricecon_importo-giu_i.rend_importo_integrato-opu.disponibilita_cassa_conto 
into disponibilita_cassa_conto
from 
OPE, opu,recon,giu_i, giu_r
;
