...
*/
-- 31.07.2017 Sofia versione obsoleta per simulazione con esclusione di determinati impegni, ricompilata versione corretta
...
CREATE OR REPLACE FUNCTION fnc_fasi_bil_prev_approva_simula (
...
begin
 ...
 (select elemTipo,gest.bil_id, prev.elem_id, gest.elem_id, gest.elem_code, gest.elem_code2, gest.elem_code3,
         gest.periodo_id,
         prev.stanziamento,
         (fnc_siac_dicuiimpegnatoug_comp_anno_16109(gest.elem_id,annobilancio::varchar)).dicuiimpegnato,
         0,
 ...
 (select elemTipo,gest.bil_id, prev.elem_id, gest.elem_id, gest.elem_code, gest.elem_code2, gest.elem_code3,
         gest.periodo_id,
         prev.stanziamento,
         (fnc_siac_dicuiimpegnatoug_comp_anno_16109(gest.elem_id,(annobilancio+1)::varchar)).dicuiimpegnato,
         0,
         0,0,0,
         faseBilElabId,loginOperazione, now(),enteProprietarioid
  from   gest, prev
 ...
 (select elemTipo,gest.bil_id, prev.elem_id, gest.elem_id, gest.elem_code, gest.elem_code2, gest.elem_code3,
         gest.periodo_id,
         prev.stanziamento,
         (fnc_siac_dicuiimpegnatoug_comp_anno_16109(gest.elem_id,(annobilancio+2)::varchar)).dicuiimpegnato,
         0,
         0,0,0,
         faseBilElabId,loginOperazione, now(),enteProprietarioid
  from   gest, prev
...
strMessaggio:='Inserimento fase_bil_t_prev_approva_simula annoCompetenza='||annobilancio::varchar||'. Nuovi capitoli di previsione.';
 ...
 (select elemTipo,gest.bil_id, null, gest.elem_id, gest.elem_code, gest.elem_code2, gest.elem_code3,
         gest.periodo_id,
         0,(fnc_siac_dicuiimpegnatoug_comp_anno_16109(gest.elem_id,annobilancio::varchar)).dicuiimpegnato, 0,
 ...
 (select elemTipo,gest.bil_id, null, gest.elem_id, gest.elem_code, gest.elem_code2, gest.elem_code3,
         gest.periodo_id,
         0,(fnc_siac_dicuiimpegnatoug_comp_anno_16109(gest.elem_id,(annobilancio+1)::varchar)).dicuiimpegnato, 0,
         0,0,0,
         faseBilElabId,loginOperazione, now(),enteProprietarioid
  from   gest
  where not exists (select 1 from prev
 ...
 (select elemTipo,gest.bil_id, null, gest.elem_id, gest.elem_code, gest.elem_code2, gest.elem_code3,
         gest.periodo_id,
         0,(fnc_siac_dicuiimpegnatoug_comp_anno_16109(gest.elem_id,(annobilancio+2)::varchar)).dicuiimpegnato,0,
         0,0,0,
         faseBilElabId,loginOperazione, now(),enteProprietarioid
  from   gest
  where not exists (select 1 from prev
