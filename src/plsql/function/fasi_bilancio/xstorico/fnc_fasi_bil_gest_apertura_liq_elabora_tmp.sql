...
--    raise notice 'fasbilElabId %',faseBilElabId;
    ...
    if coalesce(minId,0)=0 or coalesce(maxId,0)=0 then
     ...
     for movGestRec in
     (select tipo.movgest_tipo_code, m.*,
             tstipo.movgest_ts_tipo_code, ts.*,
     ...
     loop
      ...
      if codResult is null then
        ...
        ( movGestRec.movgest_ts_code,
          ...
          movGestRec.ordine,
          movGestRec.livello,
          dataEmissione, -- da capire ancora che data impostare
          enteProprietarioId,
          loginOperazione,
          loginOperazione
         )
...
--        returning movgest_classif_id into  codResult;
    ...
    /*    select 1 into codResult
	   ...
	   if codResult=-1 then
        ...
        set fl_elab='X',
            scarto_code='PLUR1',
            scarto_desc='Movimento impegno/accertamento sub  pluriennale non inserito correttamente nel nuovo bilancio'
