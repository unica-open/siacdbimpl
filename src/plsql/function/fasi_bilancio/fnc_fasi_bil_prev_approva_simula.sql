...
begin
 ...
 (select elemTipo,gest.bil_id, prev.elem_id, gest.elem_id, gest.elem_code, gest.elem_code2, gest.elem_code3,
         gest.periodo_id,
         prev.stanziamento,
         (fnc_siac_dicuiimpegnatoug_comp_anno(gest.elem_id,annobilancio::varchar)).dicuiimpegnato,
         0,
 ...
 (select elemTipo,gest.bil_id, prev.elem_id, gest.elem_id, gest.elem_code, gest.elem_code2, gest.elem_code3,
         gest.periodo_id,
         prev.stanziamento,
         (fnc_siac_dicuiimpegnatoug_comp_anno(gest.elem_id,(annobilancio+1)::varchar)).dicuiimpegnato,
         0,
         0,0,0,
         faseBilElabId,loginOperazione, now(),enteProprietarioid
  from   gest, prev
 ...
 (select elemTipo,gest.bil_id, prev.elem_id, gest.elem_id, gest.elem_code, gest.elem_code2, gest.elem_code3,
         gest.periodo_id,
         prev.stanziamento,
         (fnc_siac_dicuiimpegnatoug_comp_anno(gest.elem_id,(annobilancio+2)::varchar)).dicuiimpegnato,
         0,
         0,0,0,
         faseBilElabId,loginOperazione, now(),enteProprietarioid
  from   gest, prev
