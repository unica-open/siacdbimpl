...
*/
-- 26.04.2016 Sofia - confronto tra stanziamenti di gestione
-- impegnato/accertato, disponibile
-- pagato/incassato, disponibile

CREATE OR REPLACE FUNCTION fnc_fasi_bil_gest_check_e (
 ...
 (elem_tipo,bil_id,elem_prev_id,elem_gest_id,elem_code,elem_code2,elem_code3,
  ...
  (
   ...
   (select  cap.elem_id , det.elem_det_importo stanziamento, detCassa.elem_det_importo stanziamento_cassa,
    ...
    and   detCassa.data_cancellazione is null
    and   detCassa.validita_fine is null)*/
 (select elemTipo,gest.bil_id,/* prev.elem_id*/null, gest.elem_id, gest.elem_code, gest.elem_code2, gest.elem_code3,
         gest.periodo_id,
         gest.stanziamento,(fnc_siac_dicuiaccertatoeg_comp_anno(gest.elem_id,annobilancio::varchar)).dicuiaccertato,0,
         gest.stanziamento_cassa,(fnc_siac_totale_ordinativi(gest.elem_id,tipoOrd)),0,
 ...
 (elem_tipo,bil_id,elem_prev_id,elem_gest_id,elem_code,elem_code2,elem_code3,
  ...
  (
   ...
   (select  cap.elem_id , det.elem_det_importo stanziamento, cap.bil_id,
    ...
    and   det.data_cancellazione is null
    and   det.validita_fine is null)*/
 (select elemTipo,gest.bil_id, null /* prev.elem_id*/, gest.elem_id, gest.elem_code, gest.elem_code2, gest.elem_code3,
         gest.periodo_id,
         gest.stanziamento,(fnc_siac_dicuiaccertatoeg_comp_anno(gest.elem_id,(annobilancio+1)::varchar)).dicuiaccertato,0,
         0,0,0,
         faseBilElabId,loginOperazione, now(),enteProprietarioid
  from   gest--, prev
/*  where gest.elem_code=prev.elem_code
 ...
 (select elemTipo,gest.bil_id, null /*prev.elem_id*/, gest.elem_id, gest.elem_code, gest.elem_code2, gest.elem_code3,
         gest.periodo_id,
         gest.stanziamento,(fnc_siac_dicuiaccertatoeg_comp_anno(gest.elem_id,(annobilancio+2)::varchar)).dicuiaccertato,0,
         0,0,0,
         faseBilElabId,loginOperazione, now(),enteProprietarioid
  from   gest/*, prev
  where gest.elem_code=prev.elem_code
 ...
 (select elemTipo,gest.bil_id, null, gest.elem_id, gest.elem_code, gest.elem_code2, gest.elem_code3,
         gest.periodo_id,
         0,(fnc_siac_dicuiimpegnatoug_comp_anno(gest.elem_id,annobilancio::varchar)).dicuiimpegnato, 0,
 ...
 (select elemTipo,gest.bil_id, null, gest.elem_id, gest.elem_code, gest.elem_code2, gest.elem_code3,
         gest.periodo_id,
         0,(fnc_siac_dicuiimpegnatoug_comp_anno(gest.elem_id,(annobilancio+1)::varchar)).dicuiimpegnato, 0,
         0,0,0,
         faseBilElabId,loginOperazione, now(),enteProprietarioid
  from   gest
  where not exists (select 1 from prev
 ...
 (select elemTipo,gest.bil_id, null, gest.elem_id, gest.elem_code, gest.elem_code2, gest.elem_code3,
         gest.periodo_id,
         0,(fnc_siac_dicuiimpegnatoug_comp_anno(gest.elem_id,(annobilancio+2)::varchar)).dicuiimpegnato,0,
         0,0,0,
         faseBilElabId,loginOperazione, now(),enteProprietarioid
  from   gest
  where not exists (select 1 from prev
