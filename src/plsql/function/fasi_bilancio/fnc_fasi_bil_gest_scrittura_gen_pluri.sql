...
*/
CREATE OR REPLACE FUNCTION siac.fnc_fasi_bil_gest_scrittura_gen_pluri (
...
from 
fase_bil_t_gest_apertura_pluri a, siac_t_movgest_ts b,siac_t_movgest c,siac_t_bil d,siac_t_periodo e,
...
,siac_r_movgest_ts_stato p,siac_d_movgest_stato q
 where
b.movgest_ts_id=a.movgest_ts_id
and a.fl_elab='S'
...
where not exists (select 1 from fase_bil_t_gest_scrittura_gen_pluri zz where zz.movgest_ts_id=tbaccal.movgest_ts_id)
...
acc_evento_code:='SAC-INS';        
          ...
          INSERT INTO 
  siac.fase_bil_t_gest_scrittura_gen_pluri
(
  movgest_id,
  movgest_ts_id,
...
from 
fase_bil_t_gest_apertura_pluri a, siac_t_movgest_ts b,siac_t_movgest c,siac_t_bil d,
...
where not exists (select 1 from fase_bil_t_gest_scrittura_gen_pluri zz where 
