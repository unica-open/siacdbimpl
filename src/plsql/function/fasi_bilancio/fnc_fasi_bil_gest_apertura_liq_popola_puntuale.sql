...
*/
﻿/*create table fase_bil_t_gest_apertura_liq_puntuale
(
	fase_bil_gest_liq_p_id serial,
	liq_anno   integer,
    liq_numero integer,
    liq_id     integer,
    bil_id     integer,
...
CREATE OR REPLACE FUNCTION fnc_fasi_bil_gest_apertura_liq_popola_puntuale(
     ...
     (fase_bil_elab_id,
      ...
      (select faseBilElabId,
       ...
       from siac_t_bil bil,siac_t_liquidazione liq,
            ...
            fase_bil_t_gest_apertura_liq_puntuale pliq
       where bil.bil_id=bilancioPrecId
       and   liq.bil_id=bil.bil_id
       and   pliq.liq_id=liq.liq_id
       and   exists (select 1
