...
BEGIN
    ...
    if codResult is null then
     ...
     if faseOp is null or faseOp not in (E_FASE) then
     	raise exception ' Il bilancio deve essere in fase % o %.',E_FASE;
     end if;
     ...
     -- impegni con pagamenti, se hanno pagamenti hanno anche liquidazioni
...
/*       and   exists (select 1 from fase_bil_t_gest_apertura_liq faseliq
     ...
     -- impegni senza pagamenti ma con liquidazioni su impegno/sub
     codResult:=null;
     ...
     (fase_bil_elab_id,
      ...
      (select faseBilElabId,
       ...
       and   tipodetm.movgest_ts_det_tipo_id=detm.movgest_ts_det_tipo_id
       and   tipodetm.movgest_ts_det_tipo_code='A'
       and   exists ( select 1    -- esistono liquidazioni valide su impegno o subimpegni
...
/*       and   exists (select 1 from fase_bil_t_gest_apertura_liq faseliq
     ...
     (fase_bil_elab_id,
      ...
      (select faseBilElabId,
       ...
       and   tipodetm.movgest_ts_det_tipo_code='A'
       and   exists (select 1
                     from siac_t_liquidazione l, siac_r_liquidazione_stato rs, siac_d_liquidazione_stato stato,
                          siac_r_liquidazione_movgest rliq
