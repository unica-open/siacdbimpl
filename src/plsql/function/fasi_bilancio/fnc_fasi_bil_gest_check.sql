...
CREATE OR REPLACE FUNCTION fnc_fasi_bil_gest_check (
...
begin
 ...
 (select elemTipo,gest.bil_id,/* prev.elem_id*/null, gest.elem_id, gest.elem_code, gest.elem_code2, gest.elem_code3,
         gest.periodo_id,
         gest.stanziamento,(fnc_siac_dicuiimpegnatoug_comp_anno(gest.elem_id,annobilancio::varchar)).dicuiimpegnato,0,
...
/*  where gest.elem_code=prev.elem_code
 ...
 (select elemTipo,gest.bil_id, null /* prev.elem_id*/, gest.elem_id, gest.elem_code, gest.elem_code2, gest.elem_code3,
         gest.periodo_id,
         gest.stanziamento,(fnc_siac_dicuiimpegnatoug_comp_anno(gest.elem_id,(annobilancio+1)::varchar)).dicuiimpegnato,0,
         0,0,0,
         faseBilElabId,loginOperazione, now(),enteProprietarioid
  from   gest--, prev
/*  where gest.elem_code=prev.elem_code
 ...
 (select elemTipo,gest.bil_id, null /*prev.elem_id*/, gest.elem_id, gest.elem_code, gest.elem_code2, gest.elem_code3,
         gest.periodo_id,
         gest.stanziamento,(fnc_siac_dicuiimpegnatoug_comp_anno(gest.elem_id,(annobilancio+2)::varchar)).dicuiimpegnato,0,
         0,0,0,
         faseBilElabId,loginOperazione, now(),enteProprietarioid
  from   gest/*, prev
  where gest.elem_code=prev.elem_code
