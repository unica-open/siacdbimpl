...
-- Sofia                    and siac_d_bil_elem_stato.elem_stato_code in ('PR','VA')
...
-- Sofia							and siac_d_movgest_stato.movgest_stato_code    			in ('D','N','P')
							and siac_d_movgest_stato.movgest_stato_code    			in ('D','N')
							-- faccio la if dopo
