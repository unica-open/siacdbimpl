...
WITH (oids = false);
*/
/*drop function fnc_siac_valorizza_tbe_mov
...
begin
	...
	ragazzi vi leggevo ma che è successo altre defezioni?
...
--          and m.movgest_id not in (1143,1239,1240,1943,1698,1926,1787,1851,2969)
       -- aggiornamento del movimento ts migrato oggi
--		 and ts.movgest_ts_id in
--          (select movgest_ts_id from siac_r_migr_impegno_movgest_ts r where r.ente_proprietario_id = 32
