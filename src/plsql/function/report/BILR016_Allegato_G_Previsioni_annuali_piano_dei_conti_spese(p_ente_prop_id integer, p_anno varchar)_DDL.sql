...
*/
CREATE OR REPLACE FUNCTION siac."BILR016_Allegato_G_Previsioni_annuali_piano_dei_conti_spese" (
...
raise notice 'prima di siac_rep_pdc_spese';

insert into siac_rep_pdc_spese
...
where 	v.ente_proprietario_id =p_ente_prop_id 
		and substr(v.classif_code,1,1)='U'
        and
...
raise notice 'prima di siac_rep_cap_up_imp';
...
raise notice 'prima di siac_rep_cap_up';
...
select  tb1.elem_id, 
        ...
        user_table utente
from   
	siac_rep_cap_up_imp tb1, siac_rep_cap_up_imp tb2
...
select 	tb1.classif_code										pdc_codice,
	...
	from siac_rep_pdc_spese	tb1
    	...
    	LEFT join 	siac_rep_cap_up_imp_riga	tb3
...
delete from siac_rep_pdc_spese where utente=user_table;
