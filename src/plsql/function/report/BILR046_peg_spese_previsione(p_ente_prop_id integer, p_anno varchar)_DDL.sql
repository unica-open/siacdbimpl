...
*/
CREATE OR REPLACE FUNCTION siac."BILR046_peg_spese_previsione" (
...
from missione , programma,titusc, macroag
    /* 31/08/2016: start filtro per mis-prog-macro*/
...
--26/04/2016: aggiunta estrazione del campo UPB che è utilizzato solo per la 
-- regione (report BILR047_peg).
-- il report BILR046_peg utilizza questa procedura ma non visualizza
-- il campo UPB.
...
from 		siac_t_bil_elem_det 		capitolo_importi,
    ...
    where 	capitolo_importi.ente_proprietario_id 	=p_ente_prop_id  
        ...
        --31/08/2016: aggiunto FPV che era gestito con una seconda query 
...
from siac_rep_mptm_up_cap_importi t1
      ...
      -- 29/11/2016: la query seguente viene tolta perchè nel report non 
      --    vogliono più vedere i dati dell'anno precedente.
