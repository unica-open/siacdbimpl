...
*/
CREATE OR REPLACE FUNCTION siac."BILR020_Allegato_7_Spese_conto_capitale_incremento_attivita_fin" (
...
FROM siac_d_class_fam missione_fam, siac_t_class_fam_tree missione_tree,
    ...
    /* 05/08/2016: start filtro per mis-prog-macro*/
...
--forzatura schemi 2017 AND titusc.titusc_id = progmacro.classif_b_id
 ...
 and exists (
     select 1 from siac_r_class x, siac_t_class y, siac_d_class_tipo z
...
where 
    ...
    cat_del_capitolo.elem_cat_code	in (cap_std, cap_fpv, cap_fsc,'FPVC')
...
from   
	siac_rep_mis_pro_tit_mac_riga_anni v1
        ...
        where v1.utente = user_table 	
			/* 30/05/2016: aggiunto filtro su alcuni Missione/programma/titolo
            	come report BILR002.
                La procedura comunque estrae solo i titoli 2 e 3. */
     	/*	and	(
        		(v1.missione_code < '20' and v1.titusc_code in ('1','2','3'))
        		or (v1.missione_code = '20' and v1.programma_code='2001' and v1.titusc_code = '1')
                or (v1.missione_code = '20' and v1.programma_code in ('2002','2003') and v1.titusc_code in ('1','2'))
                or (v1.missione_code = '50' and v1.programma_code='5001' and v1.titusc_code = '1')
                or (v1.missione_code = '50' and v1.programma_code='5002' and v1.titusc_code = '4')
                or (v1.missione_code = '60' and v1.programma_code = '6001' and v1.titusc_code in ('1','5'))
                or (v1.missione_code = '99' and v1.programma_code in ('9901','9902') and v1.titusc_code = '7')
                )        */
           order by missione_code,programma_code,titusc_code,macroag_code
loop
  ...
  programma_code:= substring(classifBilRec.programma_code from 3);
