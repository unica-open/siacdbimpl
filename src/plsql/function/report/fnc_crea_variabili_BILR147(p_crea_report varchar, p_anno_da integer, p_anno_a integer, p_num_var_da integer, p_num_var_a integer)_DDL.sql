...
*/
CREATE OR REPLACE FUNCTION siac."fnc_crea_variabili_BILR147" (
...
/*
    ...
    - p_num_var_da/p_num_var_a; specificare un intervallo che indica quante
    	variabili creare. Esempio: 1 30 creerà 30 variabili.
        Se in un successivo lancio si vogliono creare nuove variabili partire
        dal valore successivo all'ultima creata. Esempio: 31 40 creerà 10 
...
/* Associazione delle variabili sulla tabella SIAC_R_REPORT_IMPORTI.
   Se lanciata più volte inserisce solo quelle che non sono già presenti */
INSERT INTO SIAC_R_REPORT_IMPORTI (rep_id,
      ...
      where  a.repimp_codice = 'IMPORTI FPV PER MISSIONE/PROGRAMMA ANNO PRECEDENTE'
    ...
    INSERT INTO BKO_T_REPORT_IMPORTI
            ...
            select  distinct 
              'BILR147',
               'Allegato b – Fondo Pluriennale Vincolato (BILR147)',
               'IMPORTI FPV PER MISSIONE/PROGRAMMA ANNO PRECEDENTE',
               '',
               0,
               'S',
               repimp_progr_riga
