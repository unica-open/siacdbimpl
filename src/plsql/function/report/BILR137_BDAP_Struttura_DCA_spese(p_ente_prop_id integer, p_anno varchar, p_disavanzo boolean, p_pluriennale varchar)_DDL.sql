...
*/
CREATE OR REPLACE FUNCTION siac."BILR137_BDAP_Struttura_DCA_spese" (
...
from 		siac_t_bil_elem_det 		capitolo_importi,
    ...
    where 	capitolo_importi.ente_proprietario_id 	=p_ente_prop_id  
        ...
        --02/08/2016: aggiunto FPV che era gestito con una seconda query 
...
raise notice '10: %', clock_timestamp()::varchar; 
      ...
      select d_class_tipo.classif_tipo_code,t_class.classif_code, 
        ...
        where t_bil_elem.elem_id=r_bil_elem_class.elem_id
          ...
          IF  classif_tipo_code = 'PDC_IV' THEN
              livello_pdc=classif_tipo_code;
              livello_pdc_code=classif_code;
          ELSE    
              livello_pdc=classif_tipo_code_padre;
              livello_pdc_code=classif_code_padre;
          END IF;
	END IF;
