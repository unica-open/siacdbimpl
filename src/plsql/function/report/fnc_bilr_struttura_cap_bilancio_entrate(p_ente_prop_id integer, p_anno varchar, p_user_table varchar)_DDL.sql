...
*/
CREATE OR REPLACE FUNCTION siac.fnc_bilr_struttura_cap_bilancio_entrate (
  p_ente_prop_id integer,
  p_anno varchar,
  p_user_table varchar
)
RETURNS TABLE (
  classif_tipo_desc1 varchar,
  titolo_id integer,
  titolo_code varchar,
  titolo_desc varchar,
  titolo_validita_inizio timestamp,
  titolo_validita_fine timestamp,
  classif_tipo_desc2 varchar,
  tipologia_id integer,
  tipologia_code varchar,
  tipologia_desc varchar,
  tipologia_validita_inizio timestamp,
  tipologia_validita_fine timestamp,
  classif_tipo_desc3 varchar,
  categoria_id integer,
  categoria_code varchar,
  categoria_desc varchar,
  categoria_validita_inizio timestamp,
  categoria_validita_fine timestamp,
...
/* FUNZIONE che estrae la struttura di bilancio dei capitoli di entrata per:
- uno specifico ente
- uno specifico anno.
...
titolo_code:='';
titolo_desc:='';
titolo_validita_inizio:=NULL;
titolo_validita_fine:=NULL;
classif_tipo_desc2:='';
tipologia_id:=NULL;
tipologia_code:='';
tipologia_desc:='';
tipologia_validita_inizio:=NULL;
tipologia_validita_fine:=NULL;
classif_tipo_desc3:='';
categoria_id:=NULL;
categoria_code:='';
categoria_desc:='';
categoria_validita_inizio:=NULL;
categoria_validita_fine:=NULL;
ente_proprietario_id:=NULL;
utente:='';



RTN_MESSAGGIO:='Ricerca della struttura blancio delle entrate';
