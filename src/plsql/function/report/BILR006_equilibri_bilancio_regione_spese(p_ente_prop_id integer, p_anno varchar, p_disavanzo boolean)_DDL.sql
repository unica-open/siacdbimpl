...
select 	v1.missione_tipo_desc			missione_tipo_desc,
    	...
    	COALESCE(tb1.stanziamento_prev_anno2,0)		stanziamento_prev_anno2,
   	 	COALESCE(tb1.stanziamento_prev_res_anno,0)	stanziamento_prev_res_anno,
    	COALESCE(tb1.stanziamento_anno_prec,0)		stanziamento_anno_prec,
...
/*from 	siac_rep_mis_pro_tit_mac_riga v1*/
