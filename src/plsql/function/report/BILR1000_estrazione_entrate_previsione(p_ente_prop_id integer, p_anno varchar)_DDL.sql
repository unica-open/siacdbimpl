...
*/
CREATE OR REPLACE FUNCTION siac."BILR1000_estrazione_entrate_previsione" (
...
IF classifBilRec.BIL_ELE_ID IS NOT NULL THEN
	...
	BEGIN    
    	...
    	and			e.classif_tipo_code		=	'RICORRENTE_ENTRATA';
    END; 
END IF;
...
IF classifBilRec.BIL_ELE_ID IS NOT NULL THEN
	...
	BEGIN    
    	...
    	and			e1.classif_tipo_code	=	'TRANSAZIONE_UE_ENTRATA'
