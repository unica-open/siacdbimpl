...
*/
CREATE OR REPLACE FUNCTION siac."BILR070_Stato_di_attuazione_spese" (
...
IF classifBilRec.ELEM_ID IS NOT NULL THEN
    ...
    BEGIN
        ...
        where 
            ...
            AND d_class_tipo.classif_tipo_desc='Assessorati'
            ...
            and capitolo.elem_id=classifBilRec.ELEM_ID
             ...
             AND capitolo.data_cancellazione is NULL;	
       IF NOT FOUND THEN
        --  RAISE EXCEPTION 'Non esiste l''assessorato per  %', classifBilRec.ELEM_ID;
        --  return;   
  		asses_code='';
  		asses_desc='';          
        END IF;
