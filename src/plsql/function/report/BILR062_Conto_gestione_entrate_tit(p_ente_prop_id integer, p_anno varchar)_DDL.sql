...
*/
CREATE OR REPLACE FUNCTION siac."BILR062_Conto_gestione_entrate_tit" (
...
--------------------------------------------------------------------------------------------------------------------------------
--- 14/06/2016: inserita l'acquisizione dei riaccertamenti residui, cioè
...
agli esercizi in cui l'obbligazione è esigibile effettuata in occasione del riaccertamento straordinario dei residui, 
 l'importo dei crediti di dubbia e difficile esazione cancellati secondo le modalità previste dal principio applicato 
 della contabilità finanziaria 9.2). La voce comprende inoltre  le rettifiche in aumento dei residui attivi effettuate 
 a seguito della riscossione di residui attivi cancellati dalle scritture (ad es. In anni precedenti è stato cancellato 
