...
*/
﻿CREATE OR REPLACE FUNCTION siac_for.fnc_dettaglio_capitolo (
...
t1.validita_fine,
  ...
  t1.login_operazione  
FROM siac_t_bil_elem_det t1, siac_t_bil_elem e1, siac_t_periodo p1, siac_t_bil b1
    WHERE  b1.periodo_id=p1.periodo_id
    and p1.anno=p_anno and 
    e1.bil_id=b1.bil_id and 
    e1.elem_id=t1.elem_id
    and e1.ente_proprietario_id=t1.ente_proprietario_id and  
    e1.ente_proprietario_id=p_ente_prop_id
    and e1.elem_code=p_elem_code
    order by 1,2
loop
