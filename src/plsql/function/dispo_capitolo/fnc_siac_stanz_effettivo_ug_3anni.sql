...
*/
-- calcolo stanziamento effettivo su capitolo di gestione
...
-- calcolo stanziamento effettivo
 ...
 -- ai fini del calcolo della disponibilita ad impegnare viene restituito per il primo anno di pluriennale
 -- il massimo impegnabile, presente eventualmente nel tipo importo MI

CREATE OR REPLACE FUNCTION fnc_siac_stanz_effettivo_ug_3anni (
...
BEGIN
 ...
 if bilElemId=0 then
     ...
     where bilElem.bil_id=bilancioId and
           ...
           tipoBilElem.elem_tipo_code = TIPO_CAP_UG;
