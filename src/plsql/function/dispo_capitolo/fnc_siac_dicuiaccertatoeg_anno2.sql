...
*/
CREATE OR REPLACE FUNCTION fnc_siac_dicuiaccertatoeg_anno2 (
  id_in integer
)
RETURNS numeric AS
$body$
...
BEGIN
    ...
    strMessaggio:='Calcolo totale accertato elem_id='||id_in||'.';
	...
	where bilElem.elem_id=id_in and
     ...
     from  fnc_siac_dicuiaccertatoeg_comp_anno (id_in,((annoBilancio::integer)+1)::varchar);
