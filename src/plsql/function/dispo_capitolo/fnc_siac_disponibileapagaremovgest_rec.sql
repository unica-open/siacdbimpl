...
*/
CREATE OR REPLACE FUNCTION siac.fnc_siac_disponibileapagaremovgest_rec (
...
BEGIN
sql_query:='SELECT movgest_ts_id, fnc_siac_disponibileapagaremovgest(movgest_ts_id) as val2
