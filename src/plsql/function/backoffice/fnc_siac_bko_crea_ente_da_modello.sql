...
SELECT distinct  tc.table_name
    ...
    and tc.table_name not in ('siac_d_ente_proprietario_tipo','siac_d_file_tipo','siac_d_evento','siac_d_flusso_elaborato_mif', 'siac_d_doc_tipo')
    and 
     tc.table_name not like 'siac_dwh%'
    order by 1    
loop 
...
/*update siac_d_pdce_fam set ambito_id = subquery.ambito_id_new
from (select 
a.pdce_fam_id, a.ente_proprietario_id ente_proprietario_id_giusto,
b.ente_proprietario_id ente_proprietario_id_errato,
b.ambito_code, b.ambito_id ambito_id_old
,c.ambito_id ambito_id_new
 from siac_d_pdce_fam a, siac_d_ambito b,siac_d_ambito c
where a.ambito_id=b.ambito_id
and 
a.ente_proprietario_id<>b.ente_proprietario_id
and 
c.ente_proprietario_id=a.ente_proprietario_id
and c.ambito_code=b.ambito_code) as subquery
where siac_d_pdce_fam.pdce_fam_id=subquery.pdce_fam_id;
*/
...
rcl1.classif_id+delta classif_id,
rcl1.classif_id_padre+delta classif_id_padre,
rcl1.ordine,
rcl1.livello,
rcl1.validita_inizio,
rcl1.validita_fine,
ente_prop_id ente_proprietario_id,
...
loop
raise notice 'classif_id+delta: %, rcl1.classif_id: %', reczz.classif_id::varchar,(reczz.classif_id-delta)::varchar;
...
VALUES(reczz.classif_fam_tree_id,
reczz.classif_id,
  reczz.classif_id_padre,
  reczz.ordine,
  reczz.livello,
  reczz.validita_inizio,
  reczz.validita_fine,
  reczz.ente_proprietario_id,
  reczz.login_operazione
);
...
siac_t_pdce_fam_tree b2, siac_d_pdce_conto_tipo c2
...
a.pdce_conto_id,a.pdce_conto_id_padre,a.livello,a.ordine,a.pdce_conto_a_partita,
...
new_pdce_conto_id_padre:=rec5.pdce_conto_id_padre;
...
ivaaliquota_code,
  ...
  ente_prop_id,
  login_operaz
  from siac_t_iva_aliquota where ente_proprietario_id=ente_prop_origine_id;
...
select 
 ivagru_code,
  ...
  data_modifica,
  data_cancellazione,
  login_operaz from siac_t_iva_gruppo
  where ente_proprietario_id=ente_prop_origine_id;
...
d.login_operazione 
from siac_t_ente_proprietario a, siac_t_sepa d
where 
...
select 
c2.causale_ep_id,b2.pdce_conto_id, a.validita_inizio, ente_prop_id, login_operaz
 from siac_r_causale_ep_pdce_conto a,
...
where 
a.pdce_conto_id=b.pdce_conto_id
...
and e2.ente_proprietario_id=ente_prop_id
and f2.ente_proprietario_id=ente_prop_id
and b.pdce_conto_code=b2.pdce_conto_code
and c.causale_ep_code=c2.causale_ep_code
and d2.ambito_code=d.ambito_code
and e2.pdce_ct_tipo_code=e.pdce_ct_tipo_code
and f2.causale_ep_tipo_code=f.causale_ep_tipo_code
and a.data_cancellazione is null
and b.data_cancellazione is null
and c.data_cancellazione is null
and d.data_cancellazione is null
...
ente_prop_id,
login_operaz
 from siac_r_causale_ep_class a, siac_t_class b, siac_t_causale_ep c,siac_d_class_tipo d
,siac_t_class b2, siac_t_causale_ep c2,siac_d_class_tipo d2
...
and b2.ente_proprietario_id=ente_prop_id
and c2.ente_proprietario_id=ente_prop_id
and b2.classif_code=b.classif_code
and c2.causale_ep_code=c.causale_ep_code
and d2.classif_tipo_id=b2.classif_tipo_id
and d2.classif_tipo_code=d.classif_tipo_code
and a.data_cancellazione is null
and b.data_cancellazione is null
and c.data_cancellazione is null
and d.data_cancellazione is null;
