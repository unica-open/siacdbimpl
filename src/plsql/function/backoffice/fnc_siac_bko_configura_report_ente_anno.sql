...
*/
drop FUNCTION is exists fnc_siac_bko_configura_report_ente
(
  p_ente integer,
  p_anno_bil varchar
);
...
CREATE OR REPLACE FUNCTION fnc_siac_bko_configura_report_ente
(
  p_ente integer,
  p_anno_bil varchar,
  p_inc varchar
...
login_operazione_loc:= login_operazione_loc||'-'||p_inc;
