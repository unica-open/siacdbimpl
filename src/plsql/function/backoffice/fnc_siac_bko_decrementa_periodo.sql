...
*/
CREATE OR REPLACE FUNCTION siac.fnc_siac_bko_decrementa_periodo (
...
select min(anno::integer) into min_anno from siac_t_periodo where
ente_proprietario_id =ente_proprietario;

anno_aggiornamento:=min_anno-1;

for anno_aggiornamento in min_anno-delta_anni .. min_anno-1 loop
...
from siac_t_periodo where anno='2016'::varchar--min_anno::varchar
 and 
ente_proprietario_id=ente_proprietario;
