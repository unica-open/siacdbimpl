...
begin
    ...
    delete migr_capitolo_eccezione
	 ...
	 -- Inserisco i capitoli solo se la procedura precedente � andata a buon fine
     ...
     insert into migr_capitolo_uscita
       ...
       (select migr_capusc_id_seq.nextval,'CAP-UP',cAnno.anno_esercizio,cAnno.nro_capitolo,cAnno.nro_articolo,1,
         -- 29.09.2015 Davide correzione descrizione Capitolo - deve essere diversa da quella dell'Articolo
         --            se num. Articolo <> 0
              --cAnno.descri,null,
              descri_capitolo.descri,cAnno.descri,
         -- 29.09.2015 Davide fine	
            tit118.titolo, 
            decode(nvl(macr118.macroaggreg,' ' ),' ',null,macr118.titolo||macr118.macroaggreg||'0000'),
            miss118.missione,decode(nvl(progr118.programma,' ' ), ' ',null,progr118.missione||progr118.programma),
            ...
            decode(nvl(capGiunta.Nro_Capitolo_u,0),0,null,
                   'U/'||capGiunta.Nro_Capitolo_e||'/'||capGiunta.Nro_Articolo_e||'||'||'CAPITOLO GIUNTA'),
         ...
         --            0,cAnno2.st_prev,0,cAnno3.st_prev,p_ente
	      -- DAVIDE - 04.11.015 aggiunti campi da migrare "di cui impegnato"
         ...
         from previsione_uscita cAnno, previsione_uscita cAnno2,previsione_uscita cAnno3, d118_prev_usc cap118,
              ...
              d118_piano_conti_usc pdcFin,unita_previsionali_base upb,
              titusc tit, categ_usc cat, vocecousc vusc,centri_resp dir, correlazioni capGiunta, migr_capitolo_eccezione capEcc,
         -- 29.09.2015 Davide correzione descrizione Capitolo - deve essere diversa da quella dell'Articolo
         --            se num. Articolo <> 0
         ...
         where cAnno.anno_creazione=p_anno_esercizio and
               ...
               dir.centro_resp (+) =cAnno.centro_resp and
               capGiunta.Anno_Esercizio (+)  = cAnno.Anno_Esercizio and
               capGiunta.Nro_Capitolo_u (+)  = cAnno.nro_capitolo and
               capGiunta.Nro_Articolo_u (+)  = cAnno.Nro_Articolo and
               capGiunta.Nro_Capitolo_e (+) != 0 and
       ...
       msgRes:='Cancellazione migr_capitolo_uscita CAP-UP. dei Capitoli con Articolo = 0,' ||
               ' quando i Capitoli hanno pi� di un Articolo';       

       delete 
         from migr_capitolo_uscita r 
        where r.tipo_capitolo='CAP-UP' 
	      and r.anno_esercizio=p_anno_esercizio 
	      and r.ente_proprietario_id=p_ente 
	      and r.numero_capitolo in (select t.numero_capitolo 
	                                 from migr_capitolo_uscita t 
							    	 where t.tipo_capitolo='CAP-UP' 
		  					  	       and t.anno_esercizio=p_anno_esercizio 
								       and t.ente_proprietario_id=p_ente 
								       and t.numero_articolo>0)
          and r.numero_articolo=0;
...
begin
    ...
    msgRes:='Inserimento migr_capitolo_uscita CAP-UG articoli.';
    insert into migr_capitolo_uscita
    (capusc_id,tipo_capitolo,anno_esercizio,numero_capitolo,numero_articolo,numero_ueb,
     descrizione,descrizione_articolo, titolo,macroaggregato,missione,programma,
     pdc_fin_quarto, pdc_fin_quinto,note, 
    ...
    (select migr_capusc_id_seq.nextval,'CAP-UG',cAnno.anno_esercizio,cAnno.nro_capitolo,cAnno.nro_articolo,1,cAnno.descri,null,
            ...
            'U'||'/'||cAnno.titolo||'||'||tit.descri, 
            'U'||'/'||cat.titolo||'.'||cat.categoria||'||'||cat.descri,
            decode(nvl(vusc.voce_eco, ' ' ), ' ',null ,
                'U'||'/'||vusc.titolo||'.'||vusc.categoria||'.'||vusc.voce_eco||'||'||vusc.descri),
            null,null,
            nvl(dir.centro_resp,'000'), null,
            decode(nvl(capEcc.Numero_Capitolo,0), 0 ,'STD',capEcc.Classe_Capitolo),
            decode(nvl(capEcc.Numero_Capitolo,0), 0 ,'S',capEcc.flag_impegnabile),
    ...
    msgRes:='Inserimento migr_capitolo_uscita CAP-UG articoli=0 senza articoli.';
    insert into migr_capitolo_uscita
    (capusc_id,tipo_capitolo,anno_esercizio,numero_capitolo,numero_articolo,numero_ueb,
     descrizione,descrizione_articolo, titolo,macroaggregato,missione,programma,
     pdc_fin_quarto, pdc_fin_quinto,note, 
    ...
    (select migr_capusc_id_seq.nextval,'CAP-UG',cAnno.anno_esercizio,cAnno.nro_capitolo,cAnno.nro_articolo,1,cAnno.descri,null,
     ...
     where cAnno.Anno_Esercizio=p_anno_esercizio and
           cAnno.nro_capitolo>=0 and cAnno.nro_articolo=0 and
           0=(select count(*) from cap_uscita cAnnoArt
              where cAnnoArt.anno_esercizio=cAnno.anno_esercizio and
                    cAnnoArt.nro_capitolo=cAnno.nro_capitolo and 
                    cAnnoArt.nro_articolo!=0
              ) and
           cAnno2.anno_esercizio=to_number(cAnno.anno_esercizio)+1 and
           cAnno2.nro_capitolo = cAnno.nro_capitolo and
           cAnno2.nro_articolo= cAnno.nro_articolo and
...
-- 29.09.2015 Davide fine				   
           ...
           decode(nvl(capGiunta.Nro_Capitolo_e,0),0,null,
           'U/'||capGiunta.Nro_Capitolo_u||'/'||capGiunta.Nro_Articolo_u||'||'||'CAPITOLO GIUNTA'),
           null,null,null,null,null,null,null,null,
...
--            0,cAnno2.st_prev,0,cAnno3.st_prev,p_ente
   from previsione_entrata cAnno, previsione_entrata cAnno2, previsione_entrata cAnno3,d118_prev_ent cap118,
        ...
        unita_previsionali_base_entr upb,centri_resp dir,
        titent tit, categorie cat, vocecoent vusc, vincoli capGiunta,migr_capitolo_eccezione capEcc,
-- 29.09.2015 Davide correzione descrizione Capitolo - deve essere diversa da quella dell'Articolo
--            se num. Articolo <> 0
...
-- 29.09.2015 Davide fine
   where cAnno.anno_creazione=p_anno_esercizio and
         ...
         dir.centro_resp (+)  =cAnno.centro_resp and
         capGiunta.Anno_Esercizio (+) = cAnno.Anno_Esercizio and
         capGiunta.Nro_Capitolo_e (+) = cAnno.Nro_Capitolo and
         capGiunta.nro_articolo_e (+) = cAnno.nro_articolo and
         capGiunta.Nro_Capitolo_u (+) !=0 and
         capEcc.Tipo_Capitolo (+)='P' and
         capEcc.Eu (+)  ='E' and
         capEcc.Anno_Esercizio (+) = cAnno.anno_esercizio and
         capEcc.numero_capitolo (+) = cAnno.Nro_Capitolo and
...
-- 29.09.2015 Davide fine
   ...
   delete 
    ...
    where r.tipo_capitolo='CAP-EP' 
	  and r.anno_esercizio=p_anno_esercizio 
	  and r.ente_proprietario_id=p_ente 
	  and r.numero_capitolo in (select t.numero_capitolo 
	                              from migr_capitolo_entrata t 
								 where t.tipo_capitolo='CAP-EP' 
								   and t.anno_esercizio=p_anno_esercizio 
								   and t.ente_proprietario_id=p_ente 
								   and t.numero_articolo>0)
      and r.numero_articolo=0;
...
begin
    ...
    (classif_tipo_id, tipo_capitolo, codice, descrizione,
     ente_proprietario_id)
    values
    (migr_classif_capitolo_id_seq.nextval,'CAP-UP','CLASSIFICATORE_2','Capitolo di Giunta correlato',p_ente);
    ...
    (classif_tipo_id, tipo_capitolo, codice, descrizione,
     ente_proprietario_id)
    values
    (migr_classif_capitolo_id_seq.nextval,'CAP-EP','CLASSIFICATORE_37','Capitolo di Giunta correlato',p_ente);
...
begin
    ...
    (classif_tipo_id, tipo_capitolo, codice, descrizione,
     ente_proprietario_id)
    values
    (migr_classif_capitolo_id_seq.nextval,'CAP-UG','CLASSIFICATORE_2','Capitolo di Giunta correlato',p_ente);
    ...
    (classif_tipo_id, tipo_capitolo, codice, descrizione,
     ente_proprietario_id)
    values
    (migr_classif_capitolo_id_seq.nextval,'CAP-EG','CLASSIFICATORE_37','Capitolo di Giunta correlato',p_ente);
...
BEGIN
   ...
   THEN
      IF p_tipo_provvedimento = PROVV_AD
      THEN
         BEGIN
         ...
         END;
      ELSIF p_tipo_provvedimento = PROVV_DG
      THEN
         BEGIN
...
--                migrazione_accertamenti(p_ente_proprietario_id, v_anno, v_codRes, v_imp_inseriti, v_imp_scartati,p_msgRes);
                migrazione_accertamenti(p_ente_proprietario_id,p_anno_esercizio,v_anno, v_codRes, v_imp_inseriti, v_imp_scartati,p_msgRes);
                v_msgRes := v_msgRes || p_msgRes ;
            end if;
  ...
  procedure migrazione_impegni(p_ente_proprietario_id number,
    ...
    is
	   ...
	   -- DAVIDE : aggiunta gestione campo parere_finanziario
...
begin
       ...
       -- Dani 28.01.015 - Per ente crp  riportiamo il numero articolo 'vero'  trovato sulla tabella impegni
       for  migrImpegno in
       ...
       loop
               ...
               begin 
                 ...
                 where --m.anno_esercizio=p_anno_esercizio and
                       ...
                       m.numero_articolo=migrImpegno.numero_articolo
                       -- DAVIDE : gestione ente proprietario nelle tabelle di migrazione
...
/*               if codRes=0 then
              ...
              --  parere_finanziario da calcolare
              if codRes=0 then
                 msgRes:='Calcolo flag parere finanziario.';
                 ...
                 if migrImpegno.numero_provvedimento is null or migrImpegno.numero_provvedimento ='0' then
                   if  h_stato_impegno!=STATO_P then
                    ...
                    if codRes=0 then
                       ...
                       if migrImpegno.tipo_provvedimento = PROVV_AD OR migrImpegno.tipo_provvedimento = PROVV_DP OR migrImpegno.tipo_provvedimento = PROVV_DD then
...
begin
       ...
       ( select i.anno_esercizio,i.annoimp anno_impegno,i.nimp numero_impegno,i.nsubimp numero_subimpegno,
         ...
         where i.anno_esercizio=p_anno_esercizio and
               ...
               (select imp.anno_esercizio||imp.anno_impegno||imp.numero_impegno from migr_impegno imp where ente_proprietario_id=p_ente_proprietario_id and tipo_movimento = TIPO_IMPEGNO_I) 
         order by 1,2,3,4
       ) 
       loop
               -- inizializza variabili
            ...
            --  pdc_finanziario ereditato da impegno migrato
              ...
              if codRes=0 then
                 ...
                 if migrImpegno.numero_provvedimento is null or migrImpegno.numero_provvedimento ='0' then
                   ...
                   -- 29.07.2015 Dani Lo stato di un sub con provvedimento assciato � DEFINITO.
                   h_stato_impegno := STATO_D;
                   if codRes=0 and h_stato_provvedimento is null then
                      h_stato_provvedimento:=h_stato_impegno;
                   end if;
              ...
              if codRes=0 then
                 ...
                 if migrImpegno.numero_provvedimento is null or migrImpegno.numero_provvedimento ='0' then
                    if h_stato_impegno!=STATO_P then
                      ...
                      -- 29.07.2015 Dani - casi da migrare con segnalazione
          ...
          --  pdc_finanziario ereditato da accertamento migrato
             ...
             exception
              ...
              if codRes=0 then
                 ...
                 if migrImpegno.numero_provvedimento is null or migrImpegno.numero_provvedimento ='0' then
                    if h_stato_impegno!=STATO_P then
                      ...
                      -- 29.07.2015 Dani casi da migrare con segnalazione
                      -- Provvedimento non passato nel cursore per subacc in stato <> 'P'
                       h_stato_provvedimento := STATO_D;
                       segnalare := true;
                       msgMotivoScarto := 'Provvedimento non presente per subacc in stato '||h_stato_impegno||'.';
                    end if; 
                 else   
                    h_anno_provvedimento:=migrImpegno.anno_provvedimento;
                    h_numero_provvedimento:=migrImpegno.numero_provvedimento;
                   ...
                   -- 29.07.2015 Dani lo stato del subacc con provvedimento � DEFINITIVO.
                   h_stato_impegno := STATO_D;
                   if codRes=0 and h_stato_provvedimento is null then
                      h_stato_provvedimento:=h_stato_impegno;
                   end if;
              ...
              then
               ...
               if codRes!=0 or ( h_soggetto_determinato='S' and  h_sogg_migrato=0) or segnalare = true then
                 if codRes!=0 then
                     msgMotivoScarto:=msgRes;
                 end if;    
...
/*                                     -- 18.09.2015
                                   ...
                                   h_tipo_provvedimento:=h_tipo_provvedimento||'||K';
                                   if migrCursor.codprov = PROVV_AD or migrCursor.Codprov = PROVV_ATTO_LIQUIDAZIONE or migrCursor.Codprov = PROVV_DP or migrCursor.Codprov = PROVV_DD then
                                      if h_direzione_provvedimento is not null then
                                         h_direzione_provvedimento:=h_direzione_provvedimento||'||K';
                                      end if;
                                   else
...
commit;
        ...
        -- SEGNALAZIONI PER Quote non pagate conannofat>=2014 su movimenti/liquidazioni non andate a residuo (quindi non migrate per anno = anno di migrazione)        msgRes := 'Segnalazione quote non pagate per impegno non migrato, impegno presente alla fonte per anno <> anno di migrazione.';
...
--     DELETE FROM migr_doc_spesa_iva_scarto WHERE ENTE_PROPRIETARIO_ID = pEnte;
     ...
     for migrCursor in 
        ...
        and   f.nprogsos!=0 -- iva ad esigibilit� differita
        and   f.nsez=s.nsez
    ...
    loop
            ...
            if codRes = 0 then 
              ...
              msgRes := 'Verifica soggetto valido.';
              -- verifica della validit� del soggetto. Ulteriore dettaglio per lo scarto.
              -- se il soggetto non � stato migrato.
              if h_sogg_migrato = 0 then
                begin
                  select nvl(count(*),0) into h_num
                  from fornitori
...
/*           if migrCursors.aliquota_anno_def is not null then
           ...
           -- se il documento � in lire le aliquote sono definite in lire           
              h_imponibile_pagato :=h_imponibile_pagato / RAPPORTO_EURO_LIRA;
              h_imposta_pagata :=h_imposta_pagata / RAPPORTO_EURO_LIRA;
