        ...
        (Select migr_provvedimento_id_seq.nextval,
                ...
                (
                  select 
                         ...
                         , NULL sac_provvedimento -- non � impostata
                         , b.codprov||'||K' as tipo_provvedimento -- � in chiave
                         , SUBSTR (a.oggetto, 1, 500) oggetto_provvedimento
                         , 'D' stato_provvedimento  -- � sempre Definitivo
                    from
              ...
              MINUS
                ...
                select 
                       ...
                       , b.codprov||'||K' as tipo_provvedimento -- � in chiave
                       , SUBSTR (a.oggetto, 1, 500) oggetto_provvedimento
                       , STATO_D stato_provvedimento  -- � sempre Definitivo
                from
                atti_enti a, tabprovved_enti b
                where a.t_tipologia_atto_id=b.t_tipologia_atto_id
                and stato <> 0 
