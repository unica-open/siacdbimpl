...
-- 15.04.2016 Sofia per reimputazione
  procedure migrazione_impegni(p_ente_proprietario_id number, p_anno_bilancio varchar2, p_anno_esercizio varchar2,p_reimputa varchar2,p_cod_res out number,p_imp_inseriti out number,p_imp_scartati out number,pMsgRes out varchar2);  
...
-- 15.04.2016 Sofia per reimputazione
  ...
  procedure migrazione_provvedimenti(pEnte number,pAnnoEsercizio varchar2,pAnni number,pCodRes out number,pProvInseriti out number,pProvScartati out number,pMsgRes out varchar2);
